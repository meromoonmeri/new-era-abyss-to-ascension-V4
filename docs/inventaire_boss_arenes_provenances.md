...
| 7 | Ruines Tordues | **Regigigas 28 + Regirock/Regice/Registeel 26** | **`sanctuaire_titans`** (seg3) | **[EoSO] « Deep Aegis Cave Regigigas Boss Arena » — donjon d'origine : Aegis Cave (PMD Explorers of Sky), import 1:1, tileset renommé Titans_Arena_Base** | `cloven_ruins_boss` | [NE] (tileset Relic_Forest_Base) |
