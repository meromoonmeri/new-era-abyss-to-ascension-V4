...
function V:initialize()
 ...
 self.enabled=os.getenv('PMDO_GROUND_VALIDATOR')=='tiny_woods_native_fixture'
 self.floor=tonumber(os.getenv('TINY_WOODS_FLOOR') or '0') or 0
 self.seed=tonumber(os.getenv('TINY_WOODS_SEED') or '424242') or 424242
...
function V:OnMapUpdate()
 ...
 self.task=TASK:BranchCoroutine(function()
  ...
  local ok,err=xpcall(function()
   ...
   GAME:EnterDungeon('tiny_woods',0,self.floor,0,RogueEssence.Data.GameProgress.DungeonStakes.Risk,true,true)
  end,debug.traceback)
