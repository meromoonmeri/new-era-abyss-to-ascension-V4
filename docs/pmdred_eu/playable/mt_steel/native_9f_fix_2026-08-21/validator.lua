...
function V:probe()
 ...
 local verdict=(w==9 and h==17 and tostring(map.Music)=='Mt. Steel.ogg' and entry_ok and terrain_ok and walkable==77 and reachable==48 and #stairs==0 and #traps==0 and map.Items.Count==0 and mob_count==1 and ally_count==1 and skarmory_ok and diglett_ok) and 'PASS' or 'FAIL'
