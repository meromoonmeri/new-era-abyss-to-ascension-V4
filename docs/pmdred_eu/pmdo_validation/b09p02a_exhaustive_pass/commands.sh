...
print('B09P02A_IDENTITY_PASS map_id=61 map_file_id=62 symbol=MAP_TEAM_BASE_INSIDE_CHARMANDER_CONSTRUCTION')
PYID
...
env "${PMDO_ENV[@]}" PMDO_GROUND_VALIDATOR=pmdred_eu_native_fixture \
  ...
  --reset-events
test "$(wc -l < "$FIX/events.jsonl")" -eq 4705
...
print('B09P02A_EXHAUSTIVE_PASS samples=1561 unique_rgba=36 termination=NORMAL_EXIT_0_NO_SIGNAL_NO_SIGSEGV_NO_ORPHANS')
PY
