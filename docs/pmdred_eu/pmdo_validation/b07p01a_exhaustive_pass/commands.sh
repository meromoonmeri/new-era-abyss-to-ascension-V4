...
test "$(sha256sum RESERVE/red_grounds/b07p01a.rsground | cut -d' ' -f1)" = 560fffc87e77eaf1c2123f9ceb84fbafdf332e941588ac52cacc7dcbf15a5d3c
test "$(sha256sum RESERVE/red_tiles/b07p01a_Base.tile | cut -d' ' -f1)" = ff7f4ddc12bc5c32551f77194c9cbf262a94d295a81d9cbb6275640aed0fd94c
"$PYTHON" - <<'PYID'
import json
...
print('B07P01A_IDENTITY_PASS map_file_id=47 symbol=MAP_TEAM_BASE_MUDKIP_CONSTRUCTION')
PYID
...
"$PYTHON" tools/run_pmdred_eu_native_fixture.py \
  --fixture "$FIX" --ground b07p01a --expected-screenshots 51 \
...
print('B07P01A_NATIVE_TERMINATION_PASS rc=0 phase=Unload')
PYTERM
...
print('B07P01A_EXHAUSTIVE_PASS samples=51 unique_rgba=32')
PY
