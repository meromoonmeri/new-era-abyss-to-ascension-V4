...
print('B08P02C_IDENTITY_PASS map_id=57 map_file_id=58 symbol=MAP_TEAM_BASE_CHARMANDER_BASIC')
PYID
...
print('B08P02C_EXHAUSTIVE_PASS samples=1921 unique_rgba=180 termination=NORMAL_EXIT_0_NO_SIGNAL_NO_SIGSEGV_NO_ORPHANS')
PY
