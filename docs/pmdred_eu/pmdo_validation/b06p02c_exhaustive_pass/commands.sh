...
test "$(sha256sum RESERVE/red_grounds/b06p02c.rsground | cut -d' ' -f1)" = 03198e72cc088127dcc6397f605637c9ebae490ac9f7febd80b72f28efbe3724
test "$(sha256sum RESERVE/red_tiles/b06p02c_Base.tile | cut -d' ' -f1)" = 4a7eb9c34fe92861dc80230da6961c60903fce06f0466f2602b8bcafebe0172a
"$PYTHON" - <<'PYID'
import json
...
print('B06P02C_IDENTITY_PASS map_file_id=46 symbol=MAP_TEAM_BASE_MUDKIP_BASIC')
PYID
...
"$PYTHON" tools/run_pmdred_eu_native_fixture.py \
  --fixture "$FIX" --ground b06p02c --expected-screenshots 1921 \
...
print('B06P02C_NATIVE_TERMINATION_PASS rc=0 phase=Unload')
PYTERM
...
print('B06P02C_EXHAUSTIVE_PASS samples=1921 unique_rgba=180')
PY
