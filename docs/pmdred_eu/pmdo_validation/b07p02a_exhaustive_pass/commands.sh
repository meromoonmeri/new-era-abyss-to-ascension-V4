...
test "$(sha256sum RESERVE/red_grounds/b07p02a.rsground | cut -d' ' -f1)" = 78bfe2cab5266663df421f23e125a6f0ffbfd1184b4de450b344cce40cca31ce
test "$(sha256sum RESERVE/red_tiles/b07p02a_Base.tile | cut -d' ' -f1)" = 9c6f1beb39b7034bb768b1239413b0b7342fb345065e368eb779fe109d8c10f8
"$PYTHON" - <<'PYID'
import json
...
print('B07P02A_IDENTITY_PASS map_file_id=50 symbol=MAP_TEAM_BASE_INSIDE_MUDKIP_CONSTRUCTION')
PYID
...
"$PYTHON" tools/run_pmdred_eu_native_fixture.py \
  --fixture "$FIX" --ground b07p02a --expected-screenshots 481 \
...
print('B07P02A_NATIVE_TERMINATION_PASS rc=0 phase=Unload')
PYTERM
...
print('B07P02A_EXHAUSTIVE_PASS samples=481 unique_rgba=233')
PY
