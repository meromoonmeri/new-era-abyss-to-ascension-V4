...
print('B09P02C_IDENTITY_PASS map_id=63 map_file_id=64 symbol=MAP_TEAM_BASE_TORCHIC_BASIC')
PYID
...
print('B09P02C_EXHAUSTIVE_PASS samples=59 unique_rgba=27 termination=NORMAL_EXIT_0_NO_SIGNAL_NO_SIGSEGV_NO_ORPHANS')
PY
