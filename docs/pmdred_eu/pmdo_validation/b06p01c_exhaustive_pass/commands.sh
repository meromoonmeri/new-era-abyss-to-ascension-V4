...
test "$(sha256sum RESERVE/red_grounds/b06p01c.rsground | cut -d' ' -f1)" = 4870b7471c108346f9f2133c7bf90a21bbead72fa75b85d83ab78fd1c7b9d9a0
test "$(sha256sum RESERVE/red_tiles/b06p01c_Base.tile | cut -d' ' -f1)" = 2398db32660589463a0b9212e4ffe7ada44e80f2d9481488a50679c98c81935a
"$PYTHON" - <<'PYID'
import json
...
print('B06P01C_IDENTITY_PASS map_file_id=43 symbol=MAP_TEAM_BASE_INSIDE_TOTODILE_BASIC')
PYID
...
"$PYTHON" tools/run_pmdred_eu_native_fixture.py \
  --fixture "$FIX" --ground b06p01c --expected-screenshots 51 \
...
print('B06P01C_NATIVE_TERMINATION_PASS rc=0 phase=Unload')
PYTERM
...
print('B06P01C_EXHAUSTIVE_PASS samples=51 unique_rgba=32')
PY
