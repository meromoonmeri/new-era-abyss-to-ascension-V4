...
test "$(sha256sum RESERVE/red_grounds/b06p02b.rsground | cut -d' ' -f1)" = d7be08ea87bf700f9e783a8e31647e3e3263e2a3e383ed1cc83df7d3c8845426
test "$(sha256sum RESERVE/red_tiles/b06p02b_Base.tile | cut -d' ' -f1)" = b589283f5822564edf2d3f39633c3dd11fb720a760263f667a883a8f58142e37
"$PYTHON" - <<'PYID'
import json
...
print('B06P02B_IDENTITY_PASS map_file_id=45 symbol=MAP_TEAM_BASE_INSIDE_TOTODILE_FINAL')
PYID
...
"$PYTHON" tools/run_pmdred_eu_native_fixture.py \
  --fixture "$FIX" --ground b06p02b --expected-screenshots 481 \
...
print('B06P02B_NATIVE_TERMINATION_PASS rc=0 phase=Unload')
PYTERM
...
print('B06P02B_EXHAUSTIVE_PASS samples=481 unique_rgba=233')
PY
