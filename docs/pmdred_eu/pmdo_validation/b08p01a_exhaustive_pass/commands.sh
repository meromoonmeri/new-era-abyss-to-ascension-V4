...
print('B08P01A_IDENTITY_PASS map_id=52 map_file_id=53 symbol=MAP_TEAM_BASE_PSYDUCK_CONSTRUCTION')
PYID
...
print('B08P01A_EXHAUSTIVE_PASS samples=51 unique_rgba=32 termination=NORMAL_EXIT_0_NO_SIGNAL_NO_SIGSEGV_NO_ORPHANS')
PY
