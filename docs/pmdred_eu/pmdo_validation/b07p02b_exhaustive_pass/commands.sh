...
test "$(sha256sum RESERVE/red_grounds/b07p02b.rsground | cut -d' ' -f1)" = 663d7f0fe27f7731d62aa22f7487e342123ab1f40a667e9eb990efe0dd62e934
test "$(sha256sum RESERVE/red_tiles/b07p02b_Base.tile | cut -d' ' -f1)" = b589283f5822564edf2d3f39633c3dd11fb720a760263f667a883a8f58142e37
"$PYTHON" - <<'PYID'
import json
...
print('B07P02B_IDENTITY_PASS map_file_id=51 symbol=MAP_TEAM_BASE_INSIDE_MUDKIP_FINAL')
PYID
...
"$PYTHON" tools/run_pmdred_eu_native_fixture.py \
  --fixture "$FIX" --ground b07p02b --expected-screenshots 481 \
...
print('B07P02B_NATIVE_TERMINATION_PASS rc=0 phase=Unload')
PYTERM
...
print('B07P02B_EXHAUSTIVE_PASS samples=481 unique_rgba=233')
PY
