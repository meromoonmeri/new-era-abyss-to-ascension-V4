...
print('B09P01A_IDENTITY_PASS map_id=58 map_file_id=59 symbol=MAP_TEAM_BASE_CHARMANDER_CONSTRUCTION')
PYID
...
print('B09P01A_EXHAUSTIVE_PASS samples=25 unique_rgba=6 termination=NORMAL_EXIT_0_NO_SIGNAL_NO_SIGSEGV_NO_ORPHANS')
PY
