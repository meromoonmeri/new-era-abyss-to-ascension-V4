...
print('B08P01C_IDENTITY_PASS map_id=54 map_file_id=55 symbol=MAP_TEAM_BASE_INSIDE_PSYDUCK_BASIC')
PYID
...
print('B08P01C_EXHAUSTIVE_PASS samples=51 unique_rgba=32 termination=NORMAL_EXIT_0_NO_SIGNAL_NO_SIGSEGV_NO_ORPHANS')
PY
