...
test "$(sha256sum RESERVE/red_grounds/b07p01b.rsground | cut -d' ' -f1)" = 901a7b88fab9cbbc20035d5801c68718e2aa289ec42aa0a5470ca342abfc84b0
test "$(sha256sum RESERVE/red_tiles/b07p01b_Base.tile | cut -d' ' -f1)" = 83f25ae821e8055af5bf31a714a07ee7dabf766f72036ed61e6d342a1e89c251
"$PYTHON" - <<'PYID'
import json
...
print('B07P01B_IDENTITY_PASS map_file_id=48 symbol=MAP_TEAM_BASE_MUDKIP_FINAL')
PYID
...
"$PYTHON" tools/run_pmdred_eu_native_fixture.py \
  --fixture "$FIX" --ground b07p01b --expected-screenshots 51 \
...
print('B07P01B_NATIVE_TERMINATION_PASS rc=0 phase=Unload')
PYTERM
...
print('B07P01B_EXHAUSTIVE_PASS samples=51 unique_rgba=32')
PY
