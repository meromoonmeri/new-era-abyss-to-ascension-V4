...
print('B08P02A_IDENTITY_PASS map_id=55 map_file_id=56 symbol=MAP_TEAM_BASE_INSIDE_PSYDUCK_CONSTRUCTION')
PYID
...
print('B08P02A_EXHAUSTIVE_PASS samples=481 unique_rgba=233 termination=NORMAL_EXIT_0_NO_SIGNAL_NO_SIGSEGV_NO_ORPHANS')
PY
