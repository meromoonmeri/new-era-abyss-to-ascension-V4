...
test "$(sha256sum RESERVE/red_grounds/b07p02c.rsground | cut -d' ' -f1)" = 14a4015073b21944f1bbf2dddf807940658761b0558fbfd9aa2b24b18fd9623b
test "$(sha256sum RESERVE/red_tiles/b07p02c_Base.tile | cut -d' ' -f1)" = 4a7eb9c34fe92861dc80230da6961c60903fce06f0466f2602b8bcafebe0172a
"$PYTHON" - <<'PYID'
import json
...
print('B07P02C_IDENTITY_PASS map_file_id=52 symbol=MAP_TEAM_BASE_PSYDUCK_BASIC')
PYID
...
"$PYTHON" tools/run_pmdred_eu_native_fixture.py \
  --fixture "$FIX" --ground b07p02c --expected-screenshots 1921 \
...
print('B07P02C_NATIVE_TERMINATION_PASS rc=0 phase=Unload')
PYTERM
...
print('B07P02C_EXHAUSTIVE_PASS samples=1921 unique_rgba=180')
PY
