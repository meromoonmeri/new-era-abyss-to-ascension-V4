#!/usr/bin/env bash
# Exact recovery/validation recipe used for the exhaustive t00p01 milestone.
...
FIX="$PWD/.runtime-cache/pmdred-eu-t00p01-full-fixture"
...
COMPARE="$PWD/.runtime-cache/pmdred-eu-t00p01-full-comparison"
