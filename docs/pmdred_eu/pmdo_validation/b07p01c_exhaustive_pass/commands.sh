...
test "$(sha256sum RESERVE/red_grounds/b07p01c.rsground | cut -d' ' -f1)" = 9a727d66f05b70942b369d977425fbdebcc20bc6dabac3f95b2d4fca55e8ef31
test "$(sha256sum RESERVE/red_tiles/b07p01c_Base.tile | cut -d' ' -f1)" = 9a05ae5f91de685f4bcd3d0b3ccfc1720ca04074d7f0e038cb8308f46043c4eb
"$PYTHON" - <<'PYID'
import json
...
print('B07P01C_IDENTITY_PASS map_file_id=49 symbol=MAP_TEAM_BASE_INSIDE_MUDKIP_BASIC')
PYID
...
"$PYTHON" tools/run_pmdred_eu_native_fixture.py \
  --fixture "$FIX" --ground b07p01c --expected-screenshots 51 \
...
print('B07P01C_NATIVE_TERMINATION_PASS rc=0 phase=Unload')
PYTERM
...
print('B07P01C_EXHAUSTIVE_PASS samples=51 unique_rgba=32')
PY
