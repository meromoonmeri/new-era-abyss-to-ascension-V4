...
test "$(sha256sum RESERVE/red_grounds/b06p02a.rsground | cut -d' ' -f1)" = 21536d8e620a02a393e55ab113da304a664e75fd1aab85e4c3239adc3575692f
test "$(sha256sum RESERVE/red_tiles/b06p02a_Base.tile | cut -d' ' -f1)" = 9c6f1beb39b7034bb768b1239413b0b7342fb345065e368eb779fe109d8c10f8
"$PYTHON" - <<'PYID'
import json
...
print('B06P02A_IDENTITY_PASS map_file_id=44 symbol=MAP_TEAM_BASE_INSIDE_TOTODILE_CONSTRUCTION')
PYID
...
"$PYTHON" tools/run_pmdred_eu_native_fixture.py \
  --fixture "$FIX" --ground b06p02a --expected-screenshots 481 \
...
print('B06P02A_NATIVE_TERMINATION_PASS rc=0 phase=Unload')
PYTERM
...
print('B06P02A_EXHAUSTIVE_PASS samples=481 unique_rgba=233')
PY
