...
| `silent_chasm` | 2 | 4 | 0 | 0 | 2 | — |
| `silver_trench` | 1 | 5 | 0 | 0 | 1 | — |
| `gloomy_forest` | 3 | 7 | 0 | 0 | 2 | — |
| `sky_tower` | 3 | 7 | 0 | 0 | 3 | — |
...
| `stormy_sea` | 1 | 5 | 0 | 0 | 1 | — |
| `thunderwave_cave` | 2 | 4 | 0 | 0 | 2 | — |
| `tiny_woods` | 2 | 4 | 0 | 0 | 2 | — |
...
- **TRANSFER** `Data/Script/halcyon/zone/fiery_field` — zone script (floor events, boss trigger) rebound to the regenerated zone
...
- **CURRENT** `Data/Zone/frosty_forest.json` — already produced by this Builder: it is the current canonical implementation
...
- **HARVEST** `Data/Ground/frosty_forest_midpoint.rsground` — canonical scene kept as-is: geometry, collisions, markers and objects are the source of truth for cutscene + battle
...
- **TRANSFER** `Data/Script/halcyon/ground/frosty_forest_midpoint` — cutscene of scene 'frosty_forest_midpoint' must follow the dungeon
...
- **CURRENT** `Data/Zone/lapis_cave.json` — already produced by this Builder: it is the current canonical implementation
...
- **TRANSFER** `Data/Script/halcyon/zone/lightning_field` — zone script (floor events, boss trigger) rebound to the regenerated zone
...
- **CURRENT** `Data/Zone/mt_blaze.json` — already produced by this Builder: it is the current canonical implementation
...
- **HARVEST** `Data/Ground/mt_blaze_midpoint.rsground` — canonical scene kept as-is: geometry, collisions, markers and objects are the source of truth for cutscene + battle
...
- **TRANSFER** `Data/Script/halcyon/ground/mt_blaze_midpoint` — cutscene of scene 'mt_blaze_midpoint' must follow the dungeon
...
- **TRANSFER** `Data/Script/halcyon/zone/mt_faraway` — zone script (floor events, boss trigger) rebound to the regenerated zone
...
- **CURRENT** `Data/Zone/mt_freeze.json` — already produced by this Builder: it is the current canonical implementation
...
- **HARVEST** `Data/Ground/mt_freeze_midpoint.rsground` — canonical scene kept as-is: geometry, collisions, markers and objects are the source of truth for cutscene + battle
...
- **TRANSFER** `Data/Script/halcyon/ground/mt_freeze_midpoint` — cutscene of scene 'mt_freeze_midpoint' must follow the dungeon
...
- **TRANSFER** `Data/Script/halcyon/ground/mont_grondant_pied` — cutscene of scene 'mont_grondant_pied' must follow the dungeon
- **TRANSFER** `RESERVE/scripts_ground/mont_grondant_pied` *(archivé)* — archived cutscene of scene 'mont_grondant_pied' to restore
- **TRANSFER** `Data/Script/halcyon/zone/mt_thunder` — zone script (floor events, boss trigger) rebound to the regenerated zone
...
- **TRANSFER** `Data/Script/halcyon/ground/caverne_trouble_fond` — cutscene of scene 'caverne_trouble_fond' must follow the dungeon
...
- **TRANSFER** `Data/Script/halcyon/zone/silver_trench` — zone script (floor events, boss trigger) rebound to the regenerated zone
...
- **HARVEST** `Data/Ground/bois_sombres_oree.rsground` — canonical scene kept as-is: geometry, collisions, markers and objects are the source of truth for cutscene + battle
...
- **TRANSFER** `Data/Script/halcyon/ground/bois_sombres_oree` — cutscene of scene 'bois_sombres_oree' must follow the dungeon
...
- **CURRENT** `Data/Zone/sky_tower.json` — already produced by this Builder: it is the current canonical implementation
...
- **CURRENT** `Data/Zone/sky_tower_summit.json` — already produced by this Builder: it is the current canonical implementation
- **HARVEST** `Data/Ground/arc_palier_celeste.rsground` — canonical scene kept as-is: geometry, collisions, markers and objects are the source of truth for cutscene + battle
- **HARVEST** `Data/Ground/arc_parvis_celeste.rsground` — canonical scene kept as-is: geometry, collisions, markers and objects are the source of truth for cutscene + battle
- **HARVEST** `Data/Ground/arc_tour_ciel_sommet.rsground` — canonical scene kept as-is: geometry, collisions, markers and objects are the source of truth for cutscene + battle
- **TRANSFER** `Data/Script/halcyon/ground/arc_palier_celeste` — cutscene of scene 'arc_palier_celeste' must follow the dungeon
...
- **TRANSFER** `Data/Script/halcyon/zone/stormy_sea` — zone script (floor events, boss trigger) rebound to the regenerated zone
...
- **TRANSFER** `Data/Script/halcyon/zone/western_cave` — zone script (floor events, boss trigger) rebound to the regenerated zone
...
- **CURRENT** `Data/Zone/wish_cave.json` — already produced by this Builder: it is the current canonical implementation
