...
function M.Enter(map)
  ...
  M.Context = LivingWorld.Context('no_name_village', 'nnv_rmvillage_spring')
  ...
  if M.SourceSeason ~= 'printemps' then
    error('NNV canonical season mismatch for nnv_rmvillage_spring: '..tostring(M.SourceSeason))
  end
