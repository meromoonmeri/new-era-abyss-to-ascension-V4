...
_Généré le 2026-08-23T21:44:02+00:00 — 51 zones vérifiées : **51 sans référence manquante**, 0 avec anomalie._
...
| `far_off_sea` | 3 | — | 30 | 0 |
| `fiery_field` | 3 | — | 39 | 0 |
| `frosty_forest` | 3 | Frosty Forest.ogg | 35 | 0 |
| `frosty_grotto` | 3 | — | 20 | 0 |
| `gloomy_forest` | 3 | Sinister Woods.ogg | 30 | 0 |
| `grand_sea` | 3 | — | 30 | 0 |
| `great_canyon` | 3 | — | 32 | 0 |
...
| `meteor_cave` | 3 | — | 17 | 0 |
| `mt_blaze` | 3 | Mt. Blaze.ogg | 31 | 0 |
| `mt_blaze_peak` | 3 | — | 19 | 0 |
| `mt_faraway` | 3 | — | 25 | 0 |
| `mt_freeze` | 3 | Mt. Freeze.ogg | 39 | 0 |
