...
print('B08P01B_IDENTITY_PASS map_id=53 map_file_id=54 symbol=MAP_TEAM_BASE_PSYDUCK_FINAL')
PYID
...
print('B08P01B_EXHAUSTIVE_PASS samples=51 unique_rgba=32 termination=NORMAL_EXIT_0_NO_SIGNAL_NO_SIGSEGV_NO_ORPHANS')
PY
