...
print('B09P01C_IDENTITY_PASS map_id=60 map_file_id=61 symbol=MAP_TEAM_BASE_INSIDE_CHARMANDER_BASIC')
PYID
...
print('B09P01C_EXHAUSTIVE_PASS samples=25 unique_rgba=6 termination=NORMAL_EXIT_0_NO_SIGNAL_NO_SIGSEGV_NO_ORPHANS')
PY
