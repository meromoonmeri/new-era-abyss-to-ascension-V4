...
print('B08P02B_IDENTITY_PASS map_id=56 map_file_id=57 symbol=MAP_TEAM_BASE_INSIDE_PSYDUCK_FINAL')
PYID
...
print('B08P02B_EXHAUSTIVE_PASS samples=481 unique_rgba=233 termination=NORMAL_EXIT_0_NO_SIGNAL_NO_SIGSEGV_NO_ORPHANS')
PY
