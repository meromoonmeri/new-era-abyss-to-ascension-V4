...
print('B09P01B_IDENTITY_PASS map_id=59 map_file_id=60 symbol=MAP_TEAM_BASE_CHARMANDER_FINAL')
PYID
...
print('B09P01B_EXHAUSTIVE_PASS samples=25 unique_rgba=6 termination=NORMAL_EXIT_0_NO_SIGNAL_NO_SIGSEGV_NO_ORPHANS')
PY
