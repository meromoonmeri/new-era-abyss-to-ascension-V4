...
print('B09P02B_IDENTITY_PASS map_id=62 map_file_id=63 symbol=MAP_TEAM_BASE_INSIDE_CHARMANDER_FINAL')
PYID
...
print('B09P02B_EXHAUSTIVE_PASS samples=1561 unique_rgba=6 termination=NORMAL_EXIT_0_NO_SIGNAL_NO_SIGSEGV_NO_ORPHANS')
PY
