-- [dungeon_builder] recâblage : scène du gardien puis combat sur l'étage d'arène du segment 1 de pitfall_valley : cinématique et combat au même endroit
...
function vallon_perdu.Enter(map)
  ...
  if LegendZones.IsDefeated('fallen_visitor') then
    ...
    GAME:ContinueDungeon("pitfall_valley", 1, 0, 0, RogueEssence.Data.GameProgress.DungeonStakes.Risk, true, false)
    return
  end
