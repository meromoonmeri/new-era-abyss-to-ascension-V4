-- [dungeon_builder] recâblage : scène du gardien puis combat sur l'étage d'arène du segment 2 de stormy_sea : cinématique et combat au même endroit
...
function abime_tempetes.Enter(map)
  ...
  if tostring(_ZONE.CurrentZoneID) == 'new_era_zone_19' then
    ...
    if SV.Reseau ~= nil and SV.Reseau.Veilleurs ~= nil and SV.Reseau.Veilleurs['new_era_zone_19'] then
      ...
      GAME:ContinueDungeon("stormy_sea", 2, 0, 0, RogueEssence.Data.GameProgress.DungeonStakes.Risk, true, false)
      return
    end
