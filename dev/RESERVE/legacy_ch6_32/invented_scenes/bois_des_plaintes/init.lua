-- [dungeon_builder] recâblage : scène du gardien puis combat sur l'étage d'arène du segment 1 de howling_forest : cinématique et combat au même endroit
...
function bois_des_plaintes.Enter(map)
  ...
  if LegendZones.IsDefeated('clearwater_ford') then
    ...
    GAME:ContinueDungeon("howling_forest", 1, 0, 0, RogueEssence.Data.GameProgress.DungeonStakes.Risk, true, false)
    return
  end
  ...
  -- 6. Titre + thème.
  BossMusic.Play('bois_des_plaintes')
