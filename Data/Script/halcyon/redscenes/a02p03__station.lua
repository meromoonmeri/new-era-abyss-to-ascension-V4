...
-- Station canonique PMD Red EU : ground a02p03 (dialogues ROM 0x0849DF7C).
-- Ordre = (script, command_index) ROM. Textes 5 langues ROM. Ops cif non ordonnancées: voir rapport.
local SkySceneKit = require 'halcyon.skyscenes.kit'
return function(hero, partner)
  -- BGM MUS_THE_MOUNTAIN_OF_FIRE: GAP (pas d'ogg extrait ROM vérifié) — aucune piste substituée
