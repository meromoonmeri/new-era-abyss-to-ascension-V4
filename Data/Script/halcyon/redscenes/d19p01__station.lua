...
-- Station canonique PMD Red EU : ground d19p01 (dialogues ROM 0x08554320).
...
return function(hero, partner)
  ...
  SkySceneKit.say({english="This! The ISunset Wing!", french="Mais... C'est la IPlume Crépuscule!", german="Dies! Die IAbendgoldfeder!", italian="Questa... è la IPiuma Tramonto!", spanish="¡Vaya! ¡Pero si es la IPluma Dorada!"})
  SkySceneKit.say({english="...I see. You came seeking the mirage Pokémon...", french="Je vois... Tu es à la recherche du Pokémon mirage...", german="...Verstehe. Das Illusion-Pokémon...", italian="... Capisco. Stai cercando il Pokémon miraggio...", spanish="Entiendo. Has llegado aquí buscando al Pokémon espejismo..."})
  SkySceneKit.say({english="... Step back.", french="... Un pas en arrière.", german="... Zurück!", italian="... Stai a distanza.", spanish="... ¡Atrás!"})
  SkySceneKit.say({english="Kyuuuuuuuuhn!", french="Kyuuuuuuuuhn!", german="Kyuuuuuuuuhn!", italian="Kyuuuuuuuuhn!", spanish="¡Fiuuuuuuuuh!"})
  SkySceneKit.say({english="The north wind swirled around the ISunset Wing!", french="Le vent du nord enveloppe la IPlume Crépuscule!", german="Der eisige Nordwind fegt durch die IAbendgoldfeder!", italian="Il vento di tramontana avvolge la IPiuma Tramonto!", spanish="¡El viento del norte se ha arremolinado en torno a la IPluma Dorada!"})
  ...
  SkySceneKit.say({english="It is the key to meeting the mirage Pokémon.", french="C'est la clé pour trouver le Pokémon mirage.", german="Sie ist der Schlüssel, um dem Illusion-Pokémon zu begegnen.", italian="Questo è lo strumento fondamentale per incontrare il Pokémon miraggio.", spanish="es la clave para encontrar al Pokémon espejismo."})
  ...
  SkySceneKit.say({english="Take it to the mountain so high that its peak is obscured by clouds.", french="Emmène-la sur la montagne dont le sommet perce les nuages.", german="Sie muss auf den Berg gebracht werden, dessen hoher Gipfel von Wolken verhüllt wird.", italian="Portala alla montagna la cui cima è avvolta dalle nuvole.", spanish="Llévala a esa montaña cuya cumbre está en las nubes..."})
  SkySceneKit.say({english="Yes... Take it to DMt. Faraway!", french="Oui... Emmène-la au DPic Inaccessible!", german="Ja... Zum DWeitweitberg!", italian="Sì... Portala sul DMonte Remoto!", spanish="Sí... ¡Llévala al DMonte Distante!"})
  SkySceneKit.say({english="The mirage Pokémon is at its peak!", french="Le Pokémon mirage se trouve au sommet!", german="Auf dem Gipfel findet man das Illusion-Pokémon!", italian="Il Pokémon miraggio si trova in cima!", spanish="¡El Pokémon espejismo se encuentra en la cima!"})
