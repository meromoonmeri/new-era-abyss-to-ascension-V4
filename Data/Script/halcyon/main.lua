...
require 'halcyon.TownPositions'  -- positions variables des PNJ (monde vivant)
require 'halcyon.ChapterTitles'  -- ecrans d'ouverture de chapitre
require 'halcyon.HeroDreams'     -- reves recurrents du heros (20 reves, Gardevoir)
PrintInfo('[NREPROBE] build 2026-08-02-I charge (main.lua) — PREMIERE ligne attendue, au LANCEMENT du jeu. Si absente: la copie du mod chargee par le jeu n est PAS celle du depot.')
