...
--[[ Grande Mer (grand_sea) — chapitre 21.
...
function grand_sea.Init(zone)
  DEBUG.EnableDbgCoro()
  SV.TemporaryFlags.LastDungeonEntered = 'grand_sea'
end

function grand_sea.EnterSegment(zone, rescuing, segmentID, mapID)
...
function grand_sea.Rescued(zone, name, mail)
  COMMON.Rescued(zone, name, mail)
end

function grand_sea.ExitSegment(zone, result, rescue, segmentID, mapID)
