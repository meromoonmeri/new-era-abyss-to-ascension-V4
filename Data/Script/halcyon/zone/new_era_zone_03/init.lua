...
function new_era_zone_03.ExitSegment(zone, result, rescue, segmentID, mapID)
  ...
  if result == RogueEssence.Data.GameProgress.ResultType.Cleared then
    ...
    if not SV.Reseau.VoiesOuvertes['new_era_zone_03'] then
      SV.Reseau.VoiesOuvertes['new_era_zone_03'] = true
      GAME:EnterGroundMap('bois_sombres_oree', 'Main_Entrance_Marker')
      return
    end
  end
