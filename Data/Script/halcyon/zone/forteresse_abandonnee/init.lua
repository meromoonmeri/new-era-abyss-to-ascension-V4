...
function forteresse_abandonnee.Init(zone)
  DEBUG.EnableDbgCoro()
  PrintInfo("=>> Init_forteresse_abandonnee")
  SV.TemporaryFlags.LastDungeonEntered = 'forteresse_abandonnee'
end

function forteresse_abandonnee.EnterSegment(zone, rescuing, segmentID, mapID)
...
function forteresse_abandonnee.Rescued(zone, name, mail)
  COMMON.Rescued(zone, name, mail)
end

function forteresse_abandonnee.ExitSegment(zone, result, rescue, segmentID, mapID)
  GeneralFunctions.RestoreIdleAnim()
  DEBUG.EnableDbgCoro()
  PrintInfo("=>> ExitSegment_forteresse_abandonnee result "..tostring(result).." segment "..tostring(segmentID))
