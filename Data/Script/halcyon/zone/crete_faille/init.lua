...
function crete_faille.Init(zone)
  DEBUG.EnableDbgCoro()
  PrintInfo("=>> Init_crete_faille")
  SV.TemporaryFlags.LastDungeonEntered = 'crete_faille'
end

function crete_faille.EnterSegment(zone, rescuing, segmentID, mapID)
...
function crete_faille.Rescued(zone, name, mail)
  COMMON.Rescued(zone, name, mail)
end

function crete_faille.ExitSegment(zone, result, rescue, segmentID, mapID)
  GeneralFunctions.RestoreIdleAnim()
  DEBUG.EnableDbgCoro()
  PrintInfo("=>> ExitSegment_crete_faille result "..tostring(result).." segment "..tostring(segmentID))
