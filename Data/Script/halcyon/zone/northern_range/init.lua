...
--[[ Chaîne Nordique (northern_range) — chapitre 16.
...
function northern_range.Init(zone)
  DEBUG.EnableDbgCoro()
  SV.TemporaryFlags.LastDungeonEntered = 'northern_range'
end

function northern_range.EnterSegment(zone, rescuing, segmentID, mapID)
...
function northern_range.Rescued(zone, name, mail)
  COMMON.Rescued(zone, name, mail)
end

function northern_range.ExitSegment(zone, result, rescue, segmentID, mapID)
