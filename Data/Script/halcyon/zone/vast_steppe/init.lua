...
function vast_steppe.ExitSegment(zone, result, rescue, segmentID, mapID)
  ...
  SV.adventure.Thief = false
	...
	elseif segmentID == 1 and ReplayEnding.FollowsRoute('vast_steppe', 4) then
	...
	elseif segmentID == 2 and ReplayEnding.FollowsRoute('vast_steppe', 4) and result ~= RogueEssence.Data.GameProgress.ResultType.Cleared then
	...
	elseif segmentID == 2 and result == RogueEssence.Data.GameProgress.ResultType.Cleared and ReplayEnding.FollowsRoute('vast_steppe', 4) then
