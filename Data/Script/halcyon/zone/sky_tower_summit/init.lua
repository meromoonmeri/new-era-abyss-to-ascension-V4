...
--[[ Sommet de la Tour Céleste (sky_tower_summit) — chapitre 10.
...
function sky_tower_summit.Init(zone)
  DEBUG.EnableDbgCoro()
  SV.TemporaryFlags.LastDungeonEntered = 'sky_tower_summit'
end

function sky_tower_summit.EnterSegment(zone, rescuing, segmentID, mapID)
...
function sky_tower_summit.Rescued(zone, name, mail)
  COMMON.Rescued(zone, name, mail)
end

function sky_tower_summit.ExitSegment(zone, result, rescue, segmentID, mapID)
