...
function searing_tunnel_miniboss_ch_5.DiedToBoss()
  ...
  -- Defaite contre le mini-boss : retour au RELAIS (point median,
  -- master_zone 48 = searing_tunnel_midpoint), la journee continue
  ...
  GROUND:CharEndAnim(partner)
  GAME:CutsceneMode(false)
  PrintInfo("[BossSeq][searing_tunnel_miniboss_ch_5] DiedToBoss -> searing_tunnel_midpoint")
  GAME:EnterGroundMap("searing_tunnel_midpoint", "Main_Entrance_Marker")
end
