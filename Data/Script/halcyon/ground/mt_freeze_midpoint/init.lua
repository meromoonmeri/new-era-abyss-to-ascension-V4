--[[ Station du Mont Gelé — midpoint de mt_freeze (route canonique PMD Red).
...
function mt_freeze_midpoint.Init(map)
  DEBUG.EnableDbgCoro()
...
function mt_freeze_midpoint.Update(map) end

function mt_freeze_midpoint.GameSave(map)
  PartnerEssentials.SaveGamePartnerPosition(CH('Teammate1'))
end

function mt_freeze_midpoint.GameLoad(map)
  PartnerEssentials.LoadGamePartnerPosition(CH('Teammate1'))
  GAME:FadeIn(20)
end

-- Sortie Nord : reprendre l'ascension (segment cime).
function mt_freeze_midpoint.North_Exit_Touch(obj, activator)
  DEBUG.EnableDbgCoro()
...
function mt_freeze_midpoint.South_Exit_Touch(obj, activator)
  DEBUG.EnableDbgCoro()
  UI:ResetSpeaker(false)
  UI:SetCenter(true)
...
function mt_freeze_midpoint.Kangaskhan_Rock_Action(obj, activator)
  GeneralFunctions.Kangashkhan_Rock_Interact(obj, activator)
end

function mt_freeze_midpoint.Teammate1_Action(chara, activator)
  DEBUG.EnableDbgCoro()
  PartnerEssentials.GetPartnerDialogue(CH('Teammate1'))
end

return mt_freeze_midpoint
