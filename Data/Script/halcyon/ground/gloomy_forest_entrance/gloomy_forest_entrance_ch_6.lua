...
function gloomy_forest_entrance_ch_6.ArrivalCutscene()
	...
	-- Arrivée latérale : la Team Dazzling s'élance pour couper la route du duo
	local walkD1 = TASK:BranchCoroutine(function()
		GeneralFunctions.EightWayMove(aria, 232, 152, false, 1.2)
		GROUND:CharAnimateTurnTo(aria, Direction.Right, 4)
	end)
	local walkD2 = TASK:BranchCoroutine(function()
		GAME:WaitFrames(8)
		GeneralFunctions.EightWayMove(sonata, 232, 184, false, 1.1)
		GROUND:CharAnimateTurnTo(sonata, Direction.Right, 4)
	end)
	local walkD3 = TASK:BranchCoroutine(function()
		GAME:WaitFrames(16)
		GeneralFunctions.EightWayMove(adagio, 224, 168, false, 1.0)
	...
	-- 6. LA TEAM DAZZLING FONCE DANS L'ENTRÉE EN PREMIER (Concours d'ego pour le sauvetage du petit de Papilusion)
	local exitD1 = TASK:BranchCoroutine(function()
		GeneralFunctions.EightWayMove(aria, 400, 152, false, 1.2)
		GeneralFunctions.EightWayMove(aria, 496, 160, false, 1.2)
		GROUND:Hide('Aria')
	end)
	local exitD2 = TASK:BranchCoroutine(function()
		GAME:WaitFrames(8)
		GeneralFunctions.EightWayMove(sonata, 400, 184, false, 1.2)
		GeneralFunctions.EightWayMove(sonata, 496, 160, false, 1.2)
		GROUND:Hide('Sonata')
	end)
	local exitD3 = TASK:BranchCoroutine(function()
		GAME:WaitFrames(16)
		GeneralFunctions.EightWayMove(adagio, 400, 168, false, 1.2)
