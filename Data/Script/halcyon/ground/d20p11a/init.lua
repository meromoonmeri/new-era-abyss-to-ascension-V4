--[[ d20p11a — Ground cinématique piloté par le curseur FutureArc.
...
local function resume()
  ...
  FutureArc.Resume('d20p11a')
end

function d20p11a.Enter(map) resume() end
function d20p11a.Update(map) end
function d20p11a.GameSave(map) end
function d20p11a.GameLoad(map) resume() end
