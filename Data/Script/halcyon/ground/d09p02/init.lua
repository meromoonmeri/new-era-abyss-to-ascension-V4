-- [dungeon_builder] scène canonique PMD Red — scène d09p02 (relay).
--[[ d09p02 — cinématique canonique de Pokémon Mystery Dungeon: Red Rescue Team.

     Structure reprise du squelette extrait de la ROM
     (RESERVE/red_scene_reference/d09p02.lua) : musique, ordre et nombre de
     répliques, actions. Aucune réplique inventée : chaque ligne est la clé de
     texte canonique `SCENE_D09P02_nnn`. Les clés absentes des Strings du mod
...
local AnimAdapter = require 'halcyon.ground.d09p02.animation_callbacks'
...
function d09p02.Enter(map)
  DEBUG.EnableDbgCoro()
  -- Canonical PMD Red relay scene between mt_blaze and mt_blaze_peak.
  -- See d05p02.Enter for the SV.CanonicalDungeons marker rationale.
  SV.CanonicalDungeons = SV.CanonicalDungeons or {}
  SV.CanonicalDungeons['mt_blaze'] = true
  GAME:FadeIn(20)
...
function d09p02.Update(map) AnimAdapter.Update(map) end
function d09p02.GameSave(map) end
function d09p02.GameLoad(map)
  GAME:FadeIn(20)
end
