...
function metano_town_ch_6.PostMissionCutscene()
	...
	SinisterLifecycle.AfterTownConsequences()
...
function metano_town_ch_6.Mawile_AdventureTalk(chara, activator)
  ...
  UI:WaitShowDialogue("Le Chapitre 6 est plein d'aventures et de rumeurs mystérieuses dans la Forêt Sinistre.")
  ...
  UI:BeginChoiceMenu("Que souhaitez-vous lui demander ?", {"La Forêt Sinistre", "La Team Dazzling", "L'expédition", "Rien"}, 1, 4)
  UI:WaitForChoice()
  local choice = UI:ChoiceResult()
  if choice == 1 then
    UI:WaitShowDialogue("La Forêt Sinistre est située juste au nord du village. L'air y est très lourd.")
...
function metano_town_ch_6.Mawile_GossipTalk(chara, activator)
  ...
  if result == 1 then
    ...
    UI:WaitShowDialogue("Faites bien attention si vous les croisez dans la Forêt Sinistre.")
...
function metano_town_ch_6.Mawile_PrepTalk(chara, activator)
  ...
  UI:WaitShowDialogue("La Forêt Sinistre ne pardonne pas le manque d'organisation.")
