...
--NPC Scripts
----------------
--Phileas, gardien des archives. Ses repliques suivent l'avancee du
--dernier acte du chapitre 5 : les Ruines Tordues. Fonction rapatriee du
--module _ch_7 lors du deplacement des Ruines vers le chapitre 5 —
--GeneralFunctions.ChapterDispatch route sur le NUMERO de chapitre, donc
--tant qu'elle vivait dans _ch_7 elle n'etait plus jamais appelee :
--Phileas serait reste muet pendant tout l'acte des Ruines.
function guild_third_floor_lobby_ch_5.Noctowl_Action(chara, activator)
  local hero = CH('PLAYER')
  local partner = CH('Teammate1')

  if SV.Chapter5.RuinsAddressGiven and not SV.Chapter5.EnteredRuins then
    ...
    SV.Chapter5.RuinsMissionAccepted = true
    GeneralFunctions.EndConversation(chara)
  elseif SV.Chapter5.DefeatedRuinsBoss and not SV.Chapter5.HeardGenesisTale then
    GeneralFunctions.StartConversation(chara,
  ...
  elseif SV.Chapter5.HeardGenesisTale then
    GeneralFunctions.StartConversation(chara,
...
--Adresse du matin qui ouvre les Ruines Tordues, dernier acte du
--chapitre 5. Rapatriee du module _ch_7 pour la meme raison que
--Noctowl_Action plus haut.
function guild_third_floor_lobby_ch_5.RuinsExpeditionAddress()
  local hero = CH('PLAYER')
  local partner = CH('Teammate1')
  local tropius, noctowl, audino, snubbull, growlithe, zigzagoon, girafarig,
        breloom, mareep, cranidos = guild_third_floor_lobby_helper.SetupMorningAddress()
  ...
  SV.Chapter5.RuinsAddressGiven = true
