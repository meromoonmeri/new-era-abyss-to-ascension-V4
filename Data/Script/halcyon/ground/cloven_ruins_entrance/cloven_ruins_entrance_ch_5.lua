...
function cloven_ruins_entrance_ch_5.Acte3(hero, partner)
  ...
  Says(shuca, "Normal", 'CR5_A119', {plum, hero})
  Says(ganlon, "Worried", 'CR5_A120', {shuca})
  Says(partner, "Normal", 'CR5_A121', {ganlon, shuca})
  Says(partner, "Determined", 'CR5_A122', {hero})
  Silence(42)
...
function cloven_ruins_entrance_ch_5.Acte4(hero, partner, plum)
  ...
  Says(phileas, "Normal", 'CR5_A98', {hero, partner})
  Says(almotz, "Happy", 'CR5_A99', {phileas})
  Says(phileas, "Normal", 'CR5_A100', {almotz})
  Silence(12)
  ...
  Says(rin, "Normal", 'CR5_A101', {hero, partner})
  Says(ganlon, "Sigh", 'CR5_A102', {rin})
  Silence(10)
  ...
  Says(penticus, "Normal", 'CR5_A129', {hyko})
  Says(almotz, "Happy", 'CR5_A130', {penticus})
  Silence(10)
  ...
  Says(phileas, "Normal", 'CR5_A123', {penticus, hyko})
  Says(penticus, "Determined", 'CR5_A124', {phileas})
  Says(rin, "Normal", 'CR5_A125', {partner, hero})
  Says(ganlon, "Sigh", 'CR5_A126', {rin})
  Says(shuca, "Normal", 'CR5_A127', {ganlon})
  Silence(12)
...
function cloven_ruins_entrance_ch_5.Acte5(hero, partner, plum, t)
  ...
  Says(plum, "Happy", 'CR5_A131', {t.rin})
  Says(t.coco, "Happy", 'CR5_A132', {plum})
  Says(plum, "Angry", 'CR5_A133', {t.coco})
  Says(t.phileas, "Normal", 'CR5_A134', {plum})
  Says(t.penticus, "Sigh", 'CR5_A135', {t.phileas})
  Says(t.kino, "Happy", 'CR5_A136', {plum})
  Silence(20)
...
function cloven_ruins_entrance_ch_5.Acte6(hero, partner, plum, t)
  ...
  Says(t.penticus, "Normal", 'CR5_A103', {hero, partner, t.phileas})
  Says(t.penticus, "Determined", 'CR5_A137', {hero, partner})
  Says(partner, "Determined", 'CR5_A104', {t.penticus, hero})
  Says(partner, "Normal", 'CR5_A138', {hero, t.phileas})
  Says(t.shuca, "Normal", 'CR5_A139', {t.ganlon})
  Says(t.ganlon, "Surprised", 'CR5_A140', {t.shuca})
  Says(t.coco, "Happy", 'CR5_A141', {t.ganlon})
  Silence(12)
  ...
  Says(t.hyko, "Determined", 'CR5_A105', {t.penticus, partner})
  Says(t.penticus, "Normal", 'CR5_A106', {t.hyko, plum})
  Says(plum, "Angry", 'CR5_A107', {t.penticus})
  Says(t.penticus, "Happy", 'CR5_A108', {plum})
  Says(t.phileas, "Normal", 'CR5_A142', {t.penticus})
  Says(t.rin, "Happy", 'CR5_A143', {t.phileas})
  Says(t.kino, "Happy", 'CR5_A144', {t.rin})
  Says(t.reinier, "Sigh", 'CR5_A145', {t.kino})
  Says(t.kino, "Joyous", 'CR5_A146', {t.reinier})
  Silence(12)
...
function cloven_ruins_entrance_ch_5.Acte7(hero, partner, plum, t)
  ...
  Says(t.hyko, "Normal", 'CR5_A147', {t.almotz})
  Says(t.almotz, "Normal", 'CR5_A148', {t.hyko})
  Says(t.coco, "Normal", 'CR5_A149', {t.rin})
  Says(t.rin, "Happy", 'CR5_A150', {t.coco})
  Says(plum, "Angry", 'CR5_A151', {t.coco, t.rin})
  Says(t.coco, "Happy", 'CR5_A152', {plum})
  Silence(12)
  ...
  Says(hero, "Normal", 'CR5_A153', {partner})
  Says(partner, "Determined", 'CR5_A154', {hero})
  Silence(24)

  -- Bonne nuit au reste de l'equipe.
  Says(t.penticus, "Normal", 'CR5_A67')
  Says(t.penticus, "Normal", 'CR5_A109', {t.kino, t.almotz})
  Says(t.kino, "Happy", 'CR5_A110', {t.penticus})
  Says(t.reinier, "Sigh", 'CR5_A111', {t.kino})
  Says(t.kino, "Happy", 'CR5_A112', {t.reinier})
  Silence(30)
...
function cloven_ruins_entrance_ch_5.MorningBody()
  ...
  Says(t.penticus, "Normal", 'CR5_A113', {hero, partner, plum})
  Says(plum, "Happy", 'CR5_A114', {t.penticus})
  Says(t.penticus, "Normal", 'CR5_A115', {plum})
  Says(t.penticus, "Determined", 'CR5_A116', {hero, partner})
  Says(t.rin, "Normal", 'CR5_A155', {t.coco})
  Says(t.coco, "Happy", 'CR5_A156', {t.rin})
  Says(t.penticus, "Normal", 'CR5_A157', {hero, partner, t.phileas})
  Says(plum, "Happy", 'CR5_A158', {t.penticus})
  Says(t.penticus, "Sigh", 'CR5_A159', {plum})
  Says(plum, "Happy", 'CR5_A160', {t.penticus})
  Says(t.penticus, "Determined", 'CR5_A161', {hero, partner})
  Says(partner, "Determined", 'CR5_A117', {t.penticus, hero})
  Silence(14)
