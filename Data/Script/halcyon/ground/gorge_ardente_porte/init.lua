-- [dungeon_builder] scène canonique PMD Red — scène d12p01 (entrance).
--[[ gorge_ardente_porte — cinématique canonique de Pokémon Mystery Dungeon: Red Rescue Team.

     Structure reprise du squelette extrait de la ROM
     (RESERVE/red_scene_reference/d12p01.lua) : musique, ordre et nombre de
     répliques, actions. Aucune réplique inventée : chaque ligne est la clé de
     texte canonique `SCENE_D12P01_nnn`. Les clés absentes des Strings du mod
