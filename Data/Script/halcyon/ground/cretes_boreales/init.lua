-- [dungeon_builder] recâblage : scène du gardien puis combat sur l'étage d'arène du segment 1 de northern_range : cinématique et combat au même endroit
...
function cretes_boreales.Enter(map)
  ...
  if LegendZones.IsDefeated('twin_rift') then
    ...
    GAME:ContinueDungeon("northern_range", 1, 0, 0, RogueEssence.Data.GameProgress.DungeonStakes.Risk, true, false)
    return
  end
