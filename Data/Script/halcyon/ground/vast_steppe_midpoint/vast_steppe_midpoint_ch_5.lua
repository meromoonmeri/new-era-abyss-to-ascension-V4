...
function vast_steppe_midpoint_ch_5.Partner_Action(chara, activator)
  ...
  elseif SV.Chapter5.SteppeGuardianLost then
    GeneralFunctions.StartConversation(chara, "Ce Cerfrousse...[pause=0] il ne frappait pas pour nous chasser.[pause=10] Il frappait pour protéger quelque chose.", "Worried")
...
function vast_steppe_midpoint_ch_5.Hyko_Action(chara, activator)
  ...
  if SV.Chapter5.SteppeGuardianDefeated then
    ...
    UI:SetSpeakerEmotion("Worried")
    UI:WaitShowDialogue("...Mais entre nous,[pause=10] un Cerfrousse de cette taille,[pause=10] ce n'est pas dans les registres.[pause=0] Rien de tout ça n'est dans les registres.")
