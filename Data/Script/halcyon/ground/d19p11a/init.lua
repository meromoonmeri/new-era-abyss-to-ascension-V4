--[[ d19p11a — Ground cinématique piloté par le curseur FutureArc.
...
local function resume()
  ...
  FutureArc.Resume('d19p11a')
end

function d19p11a.Enter(map) resume() end
function d19p11a.Update(map) end
function d19p11a.GameSave(map) end
function d19p11a.GameLoad(map) resume() end
