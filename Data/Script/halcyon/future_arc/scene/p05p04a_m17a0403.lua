...
function m17a0403.Cutscene()
  ...
  local ok, err = pcall(function()
    GAME:CutsceneMode(true)
        ...
        UI:WaitShowDialogue('C\'est comme si... plus rien ne bougeait...') -- FUT_M17A0403_001 (FR)
        -- case 0: " It's as if...[K]all movement..."
        -- case 1: " It's as if...[K]all movement..."
        UI:WaitShowDialogue('Comme si tout s\'était arrêté.') -- FUT_M17A0403_002 (FR)
        ...
        UI:WaitShowDialogue('Exactement.') -- FUT_M17A0403_003 (FR)
        UI:ResetSpeaker()
        ...
        UI:SetSpeaker(CH('Teammate1'))
        GeneralFunctions.SetEmotion('Normal')
        UI:WaitShowDialogue('Quoi ?') -- FUT_M17A0403_004 (FR)
        -- case 7: ' What?!'
        -- case 8: ' What?!'
        UI:ResetSpeaker()
        UI:SetSpeaker(STRINGS:Format("\\uE040"), true, "", -1, "", RogueEssence.Data.Gender.Unknown)
        UI:WaitShowDialogue('Hi-hi-hi !') -- FUT_M17A0403_005 (FR)
        UI:ResetSpeaker()
        ...
        UI:SetSpeaker(CH('Teammate1'))
        GeneralFunctions.SetEmotion('Surprised')
        UI:WaitShowDialogue('Wah ! J\'entends les Ténéfix !') -- FUT_M17A0403_006 (FR)
        -- case 11: ' Wah! I hear those [CS:N]Sableye[CR]!'
        -- case 12: ' Wah! I hear those [CS:N]Sableye[CR]!'
        UI:ResetSpeaker()
        UI:SetSpeaker(CH('Grovyle'))
        GeneralFunctions.SetEmotion('Normal')
        UI:WaitShowDialogue('On doit continuer à courir !') -- FUT_M17A0403_007 (FR)
        UI:ResetSpeaker()
  ...
  if not ok then
    ...
    PrintInfo('[m17a0403] scène interrompue : '..tostring(err))
  end
  return ok, err
end
