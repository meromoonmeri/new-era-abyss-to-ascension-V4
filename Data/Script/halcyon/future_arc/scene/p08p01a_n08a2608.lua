...
function n08a2608.Cutscene()
  ...
  local ok, err = pcall(function()
    GAME:CutsceneMode(true)
        ...
        GAME:FadeIn(30)
        GROUND:CharSetAnim(CH('Dusknoir'), 'Attack', false) -- param 12 = anim 2 (Attack)
        ...
        GROUND:CharSetAnim(CH('Dusknoir'), 'Pain', false) -- param 28 = anim 19 (Pain)
        pcall(function() GROUND:CharWaitAnim(CH('Dusknoir')) end)
        GAME:WaitFrames(15)
        GROUND:CharSetAnim(CH('Sableye_5'), 'Hurt', false) -- param 11 = anim 6 (Hurt)
        pcall(function() SOUND:PlayBattleSE('SSB_SE_7943') end) -- TODO SE 7943 (SE_NUM_EVENT_SUB01_TAKARABAKO)
        UI:SetSpeaker(CH('Sableye_1'))
        GeneralFunctions.SetEmotion('Sigh')
        ...
        -- WaitEffect (les appels GROUND sont bloquants)
        GROUND:CharSetAnim(CH('Dusknoir'), 'TumbleBack', false) -- param 41 = anim 32 (TumbleBack)
        pcall(function() GROUND:CharWaitAnim(CH('Dusknoir')) end)
        GAME:WaitFrames(30)
