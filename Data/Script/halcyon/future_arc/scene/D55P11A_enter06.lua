--[[
    D55P11A_enter06.lua — ARC DU FUTUR (adaptation New Era)
    Source canonique : pret/pmd-sky files/language-specific/US/SCRIPT/D55P11A/enter06.ssb
...
function enter06.Cutscene()
  ...
  if not ok then
    ...
    PrintInfo('[enter06] scène interrompue : '..tostring(err))
  end
  return ok, err
end
