--[[
    D21P21A_m18b1002.lua — ARC DU FUTUR (adaptation New Era)
    Source canonique : pret/pmd-sky files/language-specific/US/SCRIPT/D21P21A/m18b1002.ssb
...
function m18b1002.Cutscene()
  ...
  local ok, err = pcall(function()
    GAME:CutsceneMode(true)
        ...
        UI:WaitShowDialogue('(dialogue FUT_M18B1002_001)') -- FUT_M18B1002_001 (FR optionnel)
        ...
        -- back_SetGround(D21P21A) : ground courant déjà posé
        ...
        UI:SetSpeaker(CH('Teammate1'))
        GeneralFunctions.SetEmotion('Pain')
        UI:WaitShowDialogue(' Ugh... It\'s tough going, but...') -- FUT_M18B1002_002 (FR optionnel)
        -- case 3: " Ugh... It's tough going, but..."
        -- case 4: " Ugh... It's not easy, but..."
        UI:SetSpeaker(CH('Teammate1'))
        GeneralFunctions.SetEmotion('Normal')
        UI:WaitShowDialogue(' But there\'s no giving up!\n\nLet\'s keep at it, [hero]!') -- FUT_M18B1002_003 (FR optionnel)
  ...
  if not ok then PrintInfo('[m18b1002] scène interrompue : '..tostring(err)) end
end
