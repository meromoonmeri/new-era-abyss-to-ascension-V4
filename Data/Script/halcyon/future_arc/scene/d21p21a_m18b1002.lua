...
function m18b1002.Cutscene()
  ...
  local ok, err = pcall(function()
    GAME:CutsceneMode(true)
        ...
        UI:WaitShowDialogue('Argh... Nous avons échoué...') -- FUT_M18B1002_001 (FR)
        ...
        UI:SetSpeaker(CH('Teammate1'))
        GeneralFunctions.SetEmotion('Pain')
        UI:WaitShowDialogue('Argh... C\'est difficile, mais...') -- FUT_M18B1002_002 (FR)
        -- case 3: " Ugh... It's tough going, but..."
        -- case 4: " Ugh... It's not easy, but..."
        UI:SetSpeaker(CH('Teammate1'))
        GeneralFunctions.SetEmotion('Normal')
        UI:WaitShowDialogue('Mais pas question d\'abandonner ![br]Continuons, [hero] !') -- FUT_M18B1002_003 (FR)
  ...
  if not ok then
    ...
    PrintInfo('[m18b1002] scène interrompue : '..tostring(err))
  end
  return ok, err
end
