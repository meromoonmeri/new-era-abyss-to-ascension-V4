--[[
    D55P11A_enter00.lua — ARC DU FUTUR (adaptation New Era)
    Source canonique : pret/pmd-sky files/language-specific/US/SCRIPT/D55P11A/enter00.ssb
...
function enter00.Cutscene()
  ...
  local ok, err = pcall(function()
    GAME:CutsceneMode(true)
        ...
        -- NON CONVERTI : BranchScenarioNowAfter [4, 45, 4, 32]
        ...
        -- debug_Print (ignoré)
        -- debug_Print (ignoré)
        -- NON CONVERTI : BranchBit [17, 7, 53]
        -- Jump (structurel)
        -- debug_Print (ignoré)
  ...
  if not ok then
    ...
    PrintInfo('[enter00] scène interrompue : '..tostring(err))
  end
  return ok, err
end
