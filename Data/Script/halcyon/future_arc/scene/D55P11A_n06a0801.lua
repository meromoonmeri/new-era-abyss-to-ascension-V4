--[[
    D55P11A_n06a0801.lua — ARC DU FUTUR (adaptation New Era)
    Source canonique : pret/pmd-sky files/language-specific/US/SCRIPT/D55P11A/n06a0801.ssb
...
function n06a0801.Cutscene()
  ...
  local ok, err = pcall(function()
    GAME:CutsceneMode(true)
        ...
        -- message_SwitchMenu/CaseMenu : menu de choix (adaptation)
        UI:ResetSpeaker()
        -- NON CONVERTI : BranchScenarioNowAfter [4, 45, 4, 59]
        SV.Scenario.Side = 45 -- flag_SetScenario(SCENARIO_SIDE, scenario=45, level=4)
        -- main_EnterDungeon(150) : entrée donjon (mapping id REQUIS)
  ...
  if not ok then PrintInfo('[n06a0801] scène interrompue : '..tostring(err)) end
end
