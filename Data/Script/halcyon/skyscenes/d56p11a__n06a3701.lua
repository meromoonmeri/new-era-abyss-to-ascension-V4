...
-- Scène canonique PMD Sky EU : SCRIPT/D56P11A/n06a3701.ssb (ROM sha256 1fa39d35…).
...
return function(hero, partner)
  ...
  GAME:WaitFrames(2) -- join WaitExecuteLives
  pcall(function() UI:SetSpeaker(npc_npc_chaaremu) end)
  SkySceneKit.say({english="Let's hurry up and go![K] Through\nthat wall!", french=" Dépêchons![K] Traversons ce mur!", german="Beeilen wir uns![K]\nAb durch die Wand!", italian="Sbrighiamoci![K] Attraversiamo\nquella parete!", spanish="¡Pues no perdamos más tiempo![K]\n¡Vamos a atravesar el muro!"})
  -- message_Close
