...
-- Scène canonique PMD Sky EU : SCRIPT/P02P01A/um0603.ssb (ROM sha256 1fa39d35…).
...
return function(hero, partner)
  ...
  -- CallCommon CORO_MESSAGE_CLOSE_WAIT_FUNC (fermeture/attente message: géré par say())
  -- Turn2DirectionLives vers ACTOR_NPC_EREKIBURU [cible sans placement SSA dans la zone (spawn moteur NDS) : orientation non jouée]
  GAME:WaitFrames(2) -- join WaitExecuteLives
  -- Turn2DirectionLives vers ACTOR_NPC_EREKIBURU [cible sans placement SSA dans la zone (spawn moteur NDS) : orientation non jouée]
  -- Turn2DirectionLives vers ACTOR_NPC_EREKIBURU [cible sans placement SSA dans la zone (spawn moteur NDS) : orientation non jouée]
  GAME:WaitFrames(2) -- join WaitExecuteLives
