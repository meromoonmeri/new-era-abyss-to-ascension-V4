...
-- Scène canonique PMD Sky EU : SCRIPT/D06P11A/enter00.ssb (ROM sha256 1fa39d35…).
...
return function(hero, partner)
  ...
  if __sw == 9 then
  SkySceneKit.play_scene("d06p11a__um0800", "d06p11a__um08", hero, partner) -- supervision_ExecuteStationSub(LEVEL_D06P11A, 'UM08', 0) [chaînage scène ROM]
