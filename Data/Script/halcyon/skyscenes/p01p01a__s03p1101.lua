...
return function(hero, partner)
  ...
  SkySceneKit.say({english=" We should be searching outside!", french="Nous devons chercher aux\nalentours!", german=" Wir sollten draußen suchen!", italian=" Noi dobbiamo cercare fuori!", spanish=" ¡Busquemos por los alrededores!"}) -- SwitchTalk: branche default (canon générique)
end
