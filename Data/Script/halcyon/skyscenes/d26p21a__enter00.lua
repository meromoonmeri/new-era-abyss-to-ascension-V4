...
-- Scène canonique PMD Sky EU : SCRIPT/D26P21A/enter00.ssb (ROM sha256 1fa39d35…).
...
return function(hero, partner)
  ...
  if __sw == 24 then
  SkySceneKit.play_scene("d26p21a__um2300", "d26p21a__um23", hero, partner) -- supervision_ExecuteStationSub(LEVEL_D26P21A, 'UM23', 0) [chaînage scène ROM]
