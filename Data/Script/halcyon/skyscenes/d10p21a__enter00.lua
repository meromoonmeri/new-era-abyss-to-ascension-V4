...
-- Scène canonique PMD Sky EU : SCRIPT/D10P21A/enter00.ssb (ROM sha256 1fa39d35…).
...
return function(hero, partner)
  ...
  -- debug_Print('LABEL_CHARA_SET') [neutre/état moteur]
  ...
  if __sw == 11 then
  SkySceneKit.play_scene("d10p21a__um1000", "d10p21a__um10", hero, partner) -- supervision_ExecuteStationSub(LEVEL_D10P21A, 'UM10', 0) [chaînage scène ROM]
