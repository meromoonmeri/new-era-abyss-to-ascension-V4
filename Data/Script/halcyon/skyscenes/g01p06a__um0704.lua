...
-- Scène canonique PMD Sky EU : SCRIPT/G01P06A/um0704.ssb (ROM sha256 1fa39d35…).
...
return function(hero, partner)
  ...
  local npc_npc_sukatanku = SkySceneKit.spawn_npc("skuntank", 152, 208, Direction.Down, "NPC_SUKATANKU")
  ...
  SkySceneKit.say({english="The expedition will be rough.[K]\nWe'd all better be...well stocked with food.\nChaw-haw-haw!", french="L'expédition va être rude.[K]\nOn ferait tous mieux de... faire le plein de\nprovisions. Gnark gnark gnark!", german="Die Expedition wird ziemlich\nholprig werden.[K] Wir sollten alle mit Proviant\nausgestattet sein. Cha-ha-ha!", italian="La spedizione sarà dura.[K]\nFaremmo meglio a portarci... buone scorte di\ncibo. Ahr-ahr-ahr!", spanish="La expedición va a ser dura.[K]\nHay que ir bien provistos de comida.\n¡Jua, jua, jua!"})
  -- message_Close
  ...
  pcall(function() GROUND:CharTurnToCharAnimated(partner, npc_npc_sukatanku, 4) end)
  pcall(function() UI:SetSpeaker(npc_npc_sukatanku) end)
  SkySceneKit.say({english="Oh, come on! You're suspicious\nabout us guests? Chaw-haw-haw!", french="Oh, allons bon! Voilà que vous\nsoupçonnez d'honnêtes invités maintenant?\nGnark gnark gnark!", german="Oh, jetzt kommt schon, ihr\nverdächtigt eure Gäste? Cha-ha-ha!", italian="Oh, suvvia! Sospettate di noi\nospiti? Ahr-ahr-ahr!", spanish="¡Pero bueno! ¿Sospecháis de\nvuestros invitados? ¡Jua, jua, jua!"})
  pcall(function() UI:SetSpeaker(npc_npc_sukatanku) end)
