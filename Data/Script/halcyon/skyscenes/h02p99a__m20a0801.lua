...
return function(hero, partner)
  ...
  GAME:WaitFrames(2) -- join WaitEffect
  GAME:WaitFrames(2) -- join WaitExecuteLives
  SkySceneKit.say({english=" We have to hurry, then!", french=" Il faut qu'on se dépêche, alors!", german=" Dann müssen wir uns beeilen!", italian=" Dobbiamo sbrigarci, allora!", spanish=" ¡Entonces debemos darnos prisa!"}) -- SwitchTalk: branche default (canon générique)
  pcall(function() UI:SetSpeaker(npc_npc_juputoru) end)
  ...
  -- CallCommon CORO_MESSAGE_CLOSE_WAIT_FUNC (fermeture/attente message: géré par say())
  SkySceneKit.say({english=" OK.", french=" Entendu.", german=" Okay.", italian=" Ok.", spanish=" Comprendido."}) -- SwitchTalk: branche default (canon générique)
  pcall(function() GROUND:CharTurnToCharAnimated(partner, hero, 4) end)
  GAME:WaitFrames(2) -- join WaitExecuteLives
  pcall(function() GROUND:CharTurnToCharAnimated(hero, partner, 4) end)
  SkySceneKit.say({english=" Is that OK, [hero]?", french=" Ça te convient, [hero]?", german=" Ist das okay, [hero]?", italian=" Va bene, [hero]?", spanish=" ¿Te parece bien, [hero]?"}) -- SwitchTalk: branche default (canon générique)
  ...
  -- CallCommon CORO_MESSAGE_CLOSE_WAIT_FUNC (fermeture/attente message: géré par say())
  SkySceneKit.say({english=" Cross the sea...", french=" Traverser la mer...", german=" Den Ozean überqueren...", italian=" Attraversare il mare...", spanish=" Cruzar el mar..."}) -- SwitchTalk: branche default (canon générique)
  pcall(function() UI:SetSpeaker(npc_npc_juputoru) end)
