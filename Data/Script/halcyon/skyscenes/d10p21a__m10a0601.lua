...
-- Scène canonique PMD Sky EU : SCRIPT/D10P21A/m10a0601.ssb (ROM sha256 1fa39d35…).
...
return function(hero, partner)
  ...
  -- message_Close
  if (SkyProg.cmp(11, 3) == 0) then -- if ROM: scn($SCENARIO_MAIN) == [11, 3]
  pcall(function() SOUND:FadeOutBGM(60) end)
  GAME:FadeOut(false, 30)
  GAME:WaitFrames(2) -- join WaitBgm
  -- supervision_ExecuteCommon(CORO_EVENT_M10_07) [gestion de station NDS: le chargement/la coroutine commune est assurée par le harnais journey PMDO]
