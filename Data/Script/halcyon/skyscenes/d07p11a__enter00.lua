...
-- Scène canonique PMD Sky EU : SCRIPT/D07P11A/enter00.ssb (ROM sha256 1fa39d35…).
...
return function(hero, partner)
  ...
  if __sw == 9 then
  SkySceneKit.play_scene("d07p11a__um0800", "d07p11a__um08", hero, partner) -- supervision_ExecuteStationSub(LEVEL_D07P11A, 'UM08', 0) [chaînage scène ROM]
