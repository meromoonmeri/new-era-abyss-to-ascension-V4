...
-- Scène canonique PMD Sky EU : SCRIPT/D08P11A/enter00.ssb (ROM sha256 1fa39d35…).
...
return function(hero, partner)
  ...
  if __sw == 10 then
  SkySceneKit.play_scene("d08p11a__um0900", "d08p11a__um09", hero, partner) -- supervision_ExecuteStationSub(LEVEL_D08P11A, 'UM09', 0) [chaînage scène ROM]
