...
-- Scène canonique PMD Sky EU : SCRIPT/D69P41A/s12a1401.ssb (ROM sha256 1fa39d35…).
-- Dialogues 5 langues ROM embarqués ; conventions du pilote m01a0204.
local SkySceneKit = require 'halcyon.skyscenes.kit'
return function(hero, partner)
  pcall(function() SOUND:StopBGM() end)
  -- back_SetGround(LEVEL_D69P41A) [neutre/état moteur]
  ...
  SkySceneKit.say({english="[CN]The treasure box contained...[K]\n[CN]a [CS:I]Rock Horn[CR]!", french="[CN]Le Coffre au Trésor contient...[K]\n[CN]un [CS:I]Cor de Roche[CR]!", german="[CN]Die Schatzbox enthält[K]\n[CN]ein [CS:I]Felsenhorn[CR]!", italian="[CN]Il forziere contiene...[K]\n[CN]il [CS:I]Cornoroccia[CR]!", spanish="[CN]El cofre del tesoro contenía...[K]\n[CN]¡Un [CS:I]Cuerno Roca[CR]!"})
  -- CallCommon CORO_MESSAGE_CLOSE_WAIT_FUNC (fermeture/attente message: géré par say())
  -- item_Set(0, 63, 0) [table d'objets du script NDS: inventaire géré par le moteur PMDO]
  ...
  pcall(function() UI:ResetSpeaker() end)
  SkySceneKit.say({english="[CN]Oh?[K]\n[CN][CS:N]Giratina[CR] is saying something.", french="[CN]Oh![K]\n[CN][CS:N]Giratina[CR] vous parle.", german="[CN]Oh?[K]\n[CN][CS:N]Giratina[CR] will etwas sagen.", italian="[CN]Oh?[K]\n[CN][CS:N]Giratina[CR] sta dicendo qualcosa.", spanish="[CN]¿Qué?[K]\n[CN][CS:N]Giratina[CR] está diciendo algo."})
  pcall(function() UI:ResetSpeaker() end)
  ...
  -- CallCommon CORO_MESSAGE_CLOSE_WAIT_FUNC (fermeture/attente message: géré par say())
  -- switch(ProcessSpecial(PROCESS_SPECIAL_PREPARE_MENU_ACCEPT_TEAM_MEMBER, 10, 0)) [procédé/menu moteur NDS, corps vide: aucun embranchement canonique — équivalent moteur PMDO]
  ...
  GAME:WaitFrames(10)
  local npc_npc_giratyina = SkySceneKit.spawn_npc("giratina", 304, 200, Direction.Down, "NPC_GIRATYINA")
  ...
  GAME:WaitFrames(30)
  SV.SkyScenarioBitFlags = SV.SkyScenarioBitFlags or {}; SV.SkyScenarioBitFlags[37] = 0 -- $SCENARIO_MAIN_BIT_FLAG[37] = 0 (ROM)
  ...
  -- CallCommon CORO_MESSAGE_CLOSE_WAIT_FUNC (fermeture/attente message: géré par say())
  pcall(function() UI:ResetSpeaker() end)
  SkySceneKit.say({english="[CN][CS:N]Giratina[CR] was turned down\n[CN]as a team member.", french="[CN]Vous avez refusé l'offre\n[CN]de [CS:N]Giratina[CR].", german="[CN][CS:N]Giratina[CR] wird\n[CN]als Team-Mitglied abgelehnt.", italian="[CN]Non hai accettato [CS:N]Giratina[CR] come nuovo membro\n[CN]della squadra.", spanish="[CN]Has rechazado el ofrecimiento de [CS:N]Giratina[CR]\n[CN]de formar parte del equipo."})
  -- message_Close
  pcall(function() SOUND:FadeOutBGM(30) end)
  -- GAP: se_Play(7183) — id SE NDS sans portage PMDO identifié
  -- GAP: SetEffect EFFECT_WHITE_LIGHT_ENGULFING — VFX sans émote PMDO équivalente
  ...
  pcall(function() UI:ResetSpeaker() end)
  SkySceneKit.say({english="[CN][player] obtained\n[CN]a [CS:I]Rock Horn[CR], one of\n[CN]the seven treasures!", french="[CN][player] obtient\n[CN]un [CS:I]Cor de Roche[CR],\n[CN]un des sept trésors!", german="[CN][player] erhält das\n[CN][CS:I]Felsenhorn[CR], einen der sieben\n[CN]Schätze!", italian="[CN][player] ottiene\n[CN]il [CS:I]Cornoroccia[CR], uno dei\n[CN]sette tesori!", spanish="[CN][player] ha obtenido\n[CN]el [CS:I]Cuerno Roca[CR],\n[CN]¡uno de los siete tesoros!"})
  GAME:WaitFrames(2) -- join WaitMe
  -- message_Close
