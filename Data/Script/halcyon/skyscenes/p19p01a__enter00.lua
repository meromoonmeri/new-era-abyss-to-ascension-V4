...
-- Scène canonique PMD Sky EU : SCRIPT/P19P01A/enter00.ssb (ROM sha256 1fa39d35…).
...
return function(hero, partner)
  ...
  if __sw == 255 then
  -- supervision_StationCommon(33) [gestion de station NDS: le chargement/la coroutine commune est assurée par le harnais journey PMDO]
