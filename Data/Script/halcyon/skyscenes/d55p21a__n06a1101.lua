...
-- Scène canonique PMD Sky EU : SCRIPT/D55P21A/n06a1101.ssb (ROM sha256 1fa39d35…).
...
return function(hero, partner)
  ...
  -- message_Close
  if (SkyProg.cmp_side(45, 6) >= 0) then -- if ROM: scn($SCENARIO_SIDE) >= [45, 6]
  -- @label_2 [étiquette de flux ExplorerScript]
  -- main_EnterDungeon(151, 30) [transition de zone NDS: assurée par le harnais journey/EnterZone PMDO]
