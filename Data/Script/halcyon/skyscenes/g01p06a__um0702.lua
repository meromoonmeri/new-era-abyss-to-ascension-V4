...
-- Scène canonique PMD Sky EU : SCRIPT/G01P06A/um0702.ssb (ROM sha256 1fa39d35…).
...
return function(hero, partner)
  ...
  local npc_npc_zubatto = SkySceneKit.spawn_npc("zubat", 168, 232, Direction.UpLeft, "NPC_ZUBATTO")
  ...
  SkySceneKit.say({english=" We're only stocking up.", french=" On fait juste des provisions.", german=" Wir stocken nur den Vorrat auf.", italian=" Ci stiamo solo rifornendo.", spanish=" Solo venimos a por provisiones."})
  pcall(function() UI:SetSpeaker(npc_npc_zubatto) end)
  SkySceneKit.say({english="Oh, come on! Don't make nasty\nfaces at me. Heh-heh-heh!", french="Oh, ça va! Me regardez pas\ncomme ça. Hin hin hin!", german="Aber, aber. Nun macht doch nicht\nso grimmige Gesichter mir gegenüber. Hehehe!", italian="Oh, andiamo! Non guardatemi\ncosì male. Eh eh eh!", spanish="¡Venga, no me pongáis esa mala\ncara! ¡Jue, jue, jue!"})
  -- message_Close
  ...
  pcall(function() GROUND:CharTurnToCharAnimated(partner, npc_npc_zubatto, 4) end)
  pcall(function() UI:SetSpeaker(npc_npc_zubatto) end)
  SkySceneKit.say({english=" Oh? What are we doing in here?", french="Tiens? Qu'est-ce qu'on fait\nlà-dedans?", german=" Oh, was wir hier tun?", italian=" Eh? Cosa ci facciamo qui?", spanish="¿Cómo? ¿Que qué estamos\nhaciendo aquí?"})
  pcall(function() UI:SetSpeaker(npc_npc_zubatto) end)
