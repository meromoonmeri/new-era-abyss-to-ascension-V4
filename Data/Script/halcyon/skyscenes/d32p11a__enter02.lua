...
-- Scène canonique PMD Sky EU : SCRIPT/D32P11A/enter02.ssb (ROM sha256 1fa39d35…).
...
return function(hero, partner)
  ...
  -- debug_Print('NO_REJIICE') [neutre/état moteur]
  -- supervision_ExecuteCommon(CORO_EVENT_S04_22) [gestion de station NDS: le chargement/la coroutine commune est assurée par le harnais journey PMDO]
  elseif true then -- default
  -- supervision_ExecuteCommon(CORO_EVENT_S04_05) [gestion de station NDS: le chargement/la coroutine commune est assurée par le harnais journey PMDO]
