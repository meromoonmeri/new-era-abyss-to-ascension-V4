...
-- Scène canonique PMD Sky EU : SCRIPT/T00P02/enter00.ssb (ROM sha256 1fa39d35…).
-- Dialogues 5 langues ROM embarqués ; conventions du pilote m01a0204.
local SkySceneKit = require 'halcyon.skyscenes.kit'
return function(hero, partner)
  -- debug_Print('ENTER_T00P02') [neutre/état moteur]
  if false --[[BranchDebug: build debug]] then -- if ROM: debug
  -- @label_0 [étiquette de flux ExplorerScript]
  -- back_SetGround(LEVEL_T00P02) [neutre/état moteur]
