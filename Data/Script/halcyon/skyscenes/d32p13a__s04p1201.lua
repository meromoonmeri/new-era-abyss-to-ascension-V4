...
-- Scène canonique PMD Sky EU : SCRIPT/D32P13A/s04p1201.ssb (ROM sha256 1fa39d35…).
...
return function(hero, partner)
  ...
  pcall(function() UI:ResetSpeaker() end)
  SkySceneKit.say({english="[CN]The [CS:I]Unown Stones[CR] in the Treasure Bag:\n[CN][FT:1]S[FT:0], [FT:1]T[FT:0], [FT:1]E[FT:0], [FT:1]E[FT:0], and [FT:1]L[FT:0] are responding!", french="[CN]Les [CS:I]Pierres Zarbi[CR] du Sac à Trésor\n[CN][FT:1]S[FT:0], [FT:1]T[FT:0], [FT:1]E[FT:0], [FT:1]E[FT:0] et [FT:1]L[FT:0] réagissent!", german="[CN]Die [CS:I]Icognito-Steine[CR] [FT:1]S[FT:0], [FT:1]T[FT:0], [FT:1]E[FT:0], [FT:1]E[FT:0] und [FT:1]L[FT:0]\n[CN]aus dem Schatzbeutel reagieren!", italian="[CN]Le [CS:I]Pietre Unown[CR] nella Sacca dei tesori:\n[CN][FT:1]S[FT:0], [FT:1]T[FT:0], [FT:1]E[FT:0], [FT:1]E[FT:0] e [FT:1]L[FT:0] stanno reagendo!", spanish="[CN]¡Las [CS:I]Piedras Unown[CR]:\n[CN][FT:1]S[FT:0], [FT:1]T[FT:0], [FT:1]E[FT:0], [FT:1]E[FT:0] y [FT:1]L[FT:0]\n[CN]que hay en la Bolsa están reaccionando!"})
  pcall(function() UI:ResetSpeaker() end)
  ...
  -- CallCommon CORO_MESSAGE_CLOSE_WAIT_FUNC (fermeture/attente message: géré par say())
  -- switch(ProcessSpecial(PROCESS_SPECIAL_REMOVE_ITEMS_TYPE_IN_BAG, 418, 0)) [procédé/menu moteur NDS, corps vide: aucun embranchement canonique — équivalent moteur PMDO]
  -- switch(ProcessSpecial(PROCESS_SPECIAL_REMOVE_ITEMS_TYPE_IN_BAG, 419, 0)) [procédé/menu moteur NDS, corps vide: aucun embranchement canonique — équivalent moteur PMDO]
  ...
  -- switch(ProcessSpecial(PROCESS_SPECIAL_REMOVE_ITEMS_TYPE_IN_BAG, 404, 0)) [procédé/menu moteur NDS, corps vide: aucun embranchement canonique — équivalent moteur PMDO]
  -- switch(ProcessSpecial(PROCESS_SPECIAL_REMOVE_ITEMS_TYPE_IN_BAG, 411, 0)) [procédé/menu moteur NDS, corps vide: aucun embranchement canonique — équivalent moteur PMDO]
  ...
  pcall(function() UI:ResetSpeaker() end)
  SkySceneKit.say({english="[CN]The stone marker disappeared, and\n[CN]a hidden stairway was revealed!", french="[CN]La stèle disparaît,\n[CN]dévoilant un escalier caché!", german="[CN]Der Steinwegweiser ist verschwunden und\n[CN]hat eine versteckte Treppe freigelegt!", italian="[CN]La Stele scompare e si materializza\n[CN]una scalinata nascosta!", spanish="[CN]¡La losa ha desaparecido y, en su lugar,\n[CN]hay ahora una escalera secreta!"})
  GAME:WaitFrames(2) -- join WaitSe
  -- message_Close
  SV.SkyScenarioBitFlags = SV.SkyScenarioBitFlags or {}; SV.SkyScenarioBitFlags[45] = 1 -- $SCENARIO_MAIN_BIT_FLAG[45] = 1 (ROM)
  -- GAP: BGM BGM_IN_THE_DEPTHS_OF_THE_PIT non mappé au roster (REQUIRES_MOD_ASSET ou canal ambiance)
