...
-- Scène canonique PMD Sky EU : SCRIPT/G01P09A/enter05.ssb (ROM sha256 1fa39d35…).
...
return function(hero, partner)
  ...
  pcall(function() UI:ResetSpeaker() end)
  SkySceneKit.say({english="[CN]This is [CS:Y]Sunflora[CR]'s diary.\n[CN]Should we sneak a peek?", french="[CN]C'est le journal d'[CS:Y]Héliatronc[CR].\n[CN]On jette un coup d'œil?", german="[CN]Dies ist das Tagebuch von [CS:Y]Sonnflora[CR].\n[CN]Sollen wir einen Blick riskieren?", italian="[CN]È il diario di [CS:Y]Sunflora[CR].\n[CN]Gli diamo un'occhiata veloce?", spanish="[CN]Es el diario de [CS:Y]Sunflora[CR].\n[CN]¿Le echamos un vistacillo?"})
  ...
  pcall(function() UI:ResetSpeaker() end)
  SkySceneKit.say({english="[CN][CS:Y]Sunflora[CR]'s Oh My Gosh Diary\n[CN]Entry 26: Thank You!\n[CN]OO Month XX Day, Sunny", french="[CN]Ben mince alors! Journal d'[CS:Y]Héliatronc[CR]\n[CN]Article 26: Merci infiniment!\n[CN]Jour: XX Mois: OO, Beau temps", german="[CN]Auweia-Tagebuch von [CS:Y]Sonnflora[CR]\n[CN]Eintrag 26: Danke!\n[CN]Tag XX Monat OO, Sonnig", italian="[CN]Diario-shock di [CS:Y]Sunflora[CR]\n[CN]Nota 26: Grazie!\n[CN]Giorno XX Mese OO, Sole", spanish="[CN]Diario \"O sea\" de [CS:Y]Sunflora[CR]\n[CN]26. ¡Gracias!\n[CN]Día \"nosecuál\" del mes \"nimeacuerdo\""})
  pcall(function() UI:ResetSpeaker() end)
  ...
  pcall(function() UI:ResetSpeaker() end)
  SkySceneKit.say({english="Tomorrow morning, we'll give them to Team\n[team:].", french="Et demain matin, on les donnera à l'Equipe\n[team:].", german="Morgen früh werden wir sie Team\n[team:] geben.", italian="Domani mattina, le daremo al Team\n[team:].", spanish="Y mañana por la mañana se las daremos\nal [CS:X]Equipo[CR] [team:]."})
  pcall(function() UI:ResetSpeaker() end)
  ...
  pcall(function() UI:ResetSpeaker() end)
  SkySceneKit.say({english="I think they were called [c_name:NPC_PARTNER_FIRST] and\n[c_name:NPC_HERO_FIRST]...", french="[c_name:NPC_PARTNER_FIRST] et\n[c_name:NPC_HERO_FIRST], je crois...", german="Ich glaube, sie heißen [c_name:NPC_PARTNER_FIRST] und\n[c_name:NPC_HERO_FIRST].", italian="Penso che si chiamino [c_name:NPC_PARTNER_FIRST] e\n[c_name:NPC_HERO_FIRST]...", spanish="Creo que se llamaban [c_name:NPC_PARTNER_FIRST] y\n[c_name:NPC_HERO_FIRST]..."})
  pcall(function() UI:ResetSpeaker() end)
  ...
  pcall(function() UI:ResetSpeaker() end)
  SkySceneKit.say({english="Oh my gosh! So glad to meet you! I'm [CS:Y]Sunflora[CR],\nan apprentice at the guild!", french="Ben mince alors! Cher journal, ravie de te\nconnaître! Moi, c'est [CS:Y]Héliatronc[CR], je suis\napprentie à la Guilde!", german="Auweia! Erfreut, euch kennenzulernen!\nIch bin [CS:Y]Sonnflora[CR], ein Lehrling der Gilde!", italian="Evviva! Sono così contenta di conoscervi! Sono\n[CS:Y]Sunflora[CR], un'apprendista della Gilda!", spanish="¡Qué fuerte! ¡O sea, encantada de conoceros!\nSoy [CS:Y]Sunflora[CR], aprendiz del [CS:N]Pokégremio[CR]."})
  pcall(function() UI:ResetSpeaker() end)
