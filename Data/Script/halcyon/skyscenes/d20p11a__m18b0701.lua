...
return function(hero, partner)
  ...
  GAME:FadeIn(0)
  SkySceneKit.say({english=" Ugh...[K] We couldn't do it...", french="Argh...[K] On a lamentablement\néchoué...", german=" Ugh...[K] Das lief nicht gut...", italian=" Ugh...[K] È andata male...", spanish=" Ay...[K] No hemos podido..."}) -- SwitchTalk: branche default (canon générique)
  ...
  SkySceneKit.say({english=" Ugh... It's not easy, but...", french=" Argh... Ça se corse...", german=" Ugh... Es ist nicht leicht, aber...", italian=" Eh... Non è facile, ma...", spanish=" Ay... Esto no es fácil, pero..."}) -- SwitchTalk: branche default (canon générique)
  SkySceneKit.say({english="But we can't give up![K] Let's keep\nat it, [hero]!", french="... mais on ne peut pas baisser\nles bras![K] Tiens bon, [hero]!", german="Wir dürfen nicht aufgeben![K]\nBleiben wir dran, [hero]!", italian="Ma non dobbiamo mollare![K]\nCoraggio, [hero]!", spanish="¡No podemos rendirnos![K]\n¡Tenemos que seguir, [hero]!"}) -- SwitchTalk: branche default (canon générique)
end
