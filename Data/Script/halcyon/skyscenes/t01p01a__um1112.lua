...
-- Scène canonique PMD Sky EU : SCRIPT/T01P01A/um1112.ssb (ROM sha256 1fa39d35…).
...
return function(hero, partner)
  ...
  local npc_npc_yadon = SkySceneKit.spawn_npc("slowpoke", 320, 264, Direction.UpLeft, "NPC_YADON")
  ...
  -- SetAnimation(2) [anim idle native]
  -- SetAnimation(2) [anim idle native]
  local npc_npc_namakero = SkySceneKit.spawn_npc("slakoth", 296, 240, Direction.UpRight, "NPC_NAMAKERO")
  -- SetAnimation(2) [anim idle native]
  -- SetAnimation(2) [anim idle native]
  pcall(function() GROUND:CharTurnToCharAnimated(partner, npc_npc_yadon, 4) end)
  pcall(function() UI:SetSpeaker(npc_npc_yadon) end)
