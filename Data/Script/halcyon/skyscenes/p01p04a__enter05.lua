...
-- Scène canonique PMD Sky EU : SCRIPT/P01P04A/enter05.ssb (ROM sha256 1fa39d35…).
...
return function(hero, partner)
  ...
  -- @label_118 [étiquette de flux ExplorerScript]
  ...
  pcall(function() GROUND:CharTurnToCharAnimated(npc_npc_soonansu, npc_npc_soonano, 4) end)
