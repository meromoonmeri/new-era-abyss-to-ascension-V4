...
return function(hero, partner)
  ...
  do local __choice = SkySceneKit.ask({{english="Ready", french="Oui", german="Ja", italian="Sì", spanish="Sí"}, {english="Not yet", french="Non", german="Nein", italian="No", spanish="Aún no"}}) -- message_SwitchMenu(0, 1) ROM
  if __choice == 2 then
  ...
  SkySceneKit.say({english=" Yup! We're good to go!", french=" Allez! C'est parti!", german=" Jep! Wir können los!", italian=" Sì! Tutto pronto!", spanish=" ¡Sí! ¡Vamos allá!"})
  elseif ((SV.SkyVars or {}).PARTNER_TALK_KIND or 0) == 2 then -- message_SwitchTalk($PARTNER_TALK_KIND) case 2
  SkySceneKit.say({english=" Yes! We're all set!", french=" Allez! C'est parti!", german=" Ja! Wir sind bereit!", italian=" Sì! Tutto pronto!", spanish=" ¡Sí! ¡Vamos allá!"})
  else
  SkySceneKit.say({english=" Yep! Everything's ready!", french=" Allez! C'est parti!", german=" Jep! Wir können los!", italian=" Sì! Tutto pronto!", spanish=" ¡Sí! ¡Vamos allá!"})
  end
  -- CallCommon CORO_MESSAGE_CLOSE_WAIT_FUNC (fermeture/attente message: géré par say())
  ...
  pcall(function() UI:SetSpeaker(npc_npc_suriipu) end)
  SkySceneKit.say({english=" Then come over here.", french=" Alors venez par ici.", german=" Dann kommt hier herüber.", italian=" Allora venite qui.", spanish=" Acercaos."})
  -- message_Close
  ...
  pcall(function() UI:SetSpeaker(npc_npc_suriipu) end)
  SkySceneKit.say({english="I'm going to send you into\n[CS:N]Azurill[CR]'s dream.", french="Je vais vous envoyer dans\nle rêve d'[CS:N]Azurill[CR].", german="Ich schicke euch jetzt in den\nTraum von [CS:N]Azurill[CR].", italian="Vi farò entrare nel sogno di\n[CS:N]Azurill[CR].", spanish="Os voy a enviar al sueño de\n[CS:N]Azurill[CR]."})
  pcall(function() UI:SetSpeaker(npc_npc_suriipu) end)
  SkySceneKit.say({english=" Here goes!", french=" C'est parti!", german=" Und los geht's!", italian=" Ecco!", spanish=" ¡Vamos allá!"})
  -- message_Close
  ...
  SkySceneKit.play_scene("d37p11a__s20p090200", "d37p11a__s20p0902", hero, partner) -- supervision_ExecuteActing(LEVEL_D37P11A, 'S20P0902', 0) [chaînage scène ROM]
  ...
  pcall(function() UI:SetSpeaker(npc_npc_suriipu) end)
  SkySceneKit.say({english=" Tell me when you're ready.", french=" Quand vous voudrez.", german="Lasst mich wissen, wenn ihr\nso weit seid.", italian="Avvertitemi quando avete\nultimato i preparativi.", spanish=" Avisadme y empezaremos."})
  -- message_Close
  else -- default/annulation
  -- CallCommon CORO_MESSAGE_CLOSE_WAIT_FUNC (fermeture/attente message: géré par say())
