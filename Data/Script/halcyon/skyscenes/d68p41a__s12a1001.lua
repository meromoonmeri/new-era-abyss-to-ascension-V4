...
-- Scène canonique PMD Sky EU : SCRIPT/D68P41A/s12a1001.ssb (ROM sha256 1fa39d35…).
-- Dialogues 5 langues ROM embarqués ; conventions du pilote m01a0204.
local SkySceneKit = require 'halcyon.skyscenes.kit'
return function(hero, partner)
  pcall(function() SOUND:StopBGM() end)
  pcall(function() UI:WaitShowTitle(GAME:GetCurrentGround().Name:ToLocal(), 30) end) -- back_SetDungeonBanner(74, 0)
  GAME:FadeIn(16)
  GAME:WaitFrames(60)
  ...
  local npc_npc_kaiooga = SkySceneKit.spawn_npc("kyogre", 304, 208, Direction.Down, "NPC_KAIOOGA")
  ...
  pcall(function() UI:SetSpeaker(npc_npc_kaiooga) end)
  ...
  pcall(function() UI:SetSpeaker(npc_npc_kaiooga) end)
  SkySceneKit.say({english="I am [CS:N]Kyogre[CR]![K] The guardian of\n[CS:P]Bottomless Sea[CR]!", french="Je suis [CS:N]Kyogre[CR]![K] Le gardien\nde la [CS:P]Mer Sans Fond[CR]!", german="Ich bin [CS:N]Kyogre[CR],[K] Wächter\ndes [CS:P]Abgrundmeeres[CR]!", italian="Io sono [CS:N]Kyogre[CR],[K] il guardiano\ndel [CS:P]Mar Voragine[CR]!", spanish="¡Soy [CS:N]Kyogre[CR]![K]\n¡Y guardo el [CS:P]Mar Insondable[CR]!"})
  -- message_FacePositionOffset(2, 0) [neutre/état moteur]
  pcall(function() UI:SetSpeaker(npc_npc_kaiooga) end)
  ...
  GAME:WaitFrames(10)
  pcall(function() UI:SetSpeaker(npc_npc_kaiooga) end)
  SkySceneKit.say({english=" Calm the raging waves...", french="Domptez les vagues\nimpétueuses...", german=" Besänftigt die wilden Wellen...", italian="... devi calmare\nle onde furiose.", spanish=" Calma las olas embravecidas..."})
  pcall(function() UI:SetSpeaker(npc_npc_kaiooga) end)
