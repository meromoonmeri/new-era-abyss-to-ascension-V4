...
-- Scène canonique PMD Sky EU : SCRIPT/T01P02A/um2101.ssb (ROM sha256 1fa39d35…).
...
return function(hero, partner)
  ...
  local npc_npc_diguda = SkySceneKit.spawn_npc("diglett", 232, 232, Direction.Right, "NPC_DIGUDA")
  ...
  -- SetAnimation(2) [anim idle native]
  -- SetAnimation(2) [anim idle native]
  local npc_npc_dogoomu = SkySceneKit.spawn_npc("loudred", 304, 248, Direction.UpRight, "NPC_DOGOOMU")
  -- SetAnimation(2) [anim idle native]
  -- SetAnimation(2) [anim idle native]
  pcall(function() GROUND:CharTurnToCharAnimated(partner, npc_npc_diguda, 4) end)
  pcall(function() UI:SetSpeaker(npc_npc_diguda) end)
  ...
  -- Turn2DirectionLives vers ACTOR_NPC_DAGUTORIO [cible sans placement SSA dans la zone (spawn moteur NDS) : orientation non jouée]
