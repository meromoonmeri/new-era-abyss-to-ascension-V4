...
return function(hero, partner)
  ...
  GAME:WaitFrames(2) -- join WaitExecuteLives
  GAME:WaitFrames(30)
  SkySceneKit.say({english=" Wh-where...?", french=" Où... où...?", german=" W-wo?", italian=" D-Dove...?", spanish=" ¿Dónde?"}) -- SwitchTalk: branche default (canon générique)
  ...
  SkySceneKit.say({english=" Are you all right, [hero]?", french=" Tu vas bien, [hero]?", german=" Geht es dir gut, [hero]?", italian=" Come ti senti, [hero]?", spanish=" ¿Estás bien, [hero]?"}) -- SwitchTalk: branche default (canon générique)
  ...
  GROUND:EntTurn(partner, Direction.UpRight)
  GAME:WaitFrames(2) -- join WaitExecuteLives
  SkySceneKit.say({english=" Is [CS:N]Azelf[CR] OK?", french=" Est-ce qu'il va bien?", german=" Geht es [CS:N]Tobutz[CR] gut?", italian=" Qualcuno ha notizie di [CS:N]Azelf[CR]?", spanish=" ¿Está bien [CS:N]Azelf[CR]?"}) -- SwitchTalk: branche default (canon générique)
  ...
  GAME:WaitFrames(2) -- join WaitExecuteLives
  SkySceneKit.say({english=" Oh, I'm glad to hear that!", french=" Excellente nouvelle!", german=" Oh, da bin ich erleichtert!", italian=" Bene!", spanish=" ¡Me alegra saberlo!"}) -- SwitchTalk: branche default (canon générique)
  pcall(function() UI:SetSpeaker(npc_npc_chiriin) end)
  ...
  GAME:WaitFrames(2) -- join WaitExecuteLives
  -- CallCommon CORO_MESSAGE_CLOSE_WAIT_FUNC (fermeture/attente message: géré par say())
  SkySceneKit.say({english="You guys are getting so\nemotional about this!", french="Oh, allez les gars, vous n'allez\npas pleurer quand même.", german="Ihr habt euch ja wirklich Sorgen\ngemacht!", italian="Grazie ragazzi, ma vi prego,\nnon esagerate!", spanish=" ¡Tampoco es para tanto!"}) -- SwitchTalk: branche default (canon générique)
  pcall(function() SOUND:FadeOutBGM(30) end)
  pcall(function() SOUND:PlayBattleSE("EVT_Emote_Complain") end)
  pcall(function() GROUND:CharSetEmote(partner, "exclaim", 1) end)
  GAME:WaitFrames(2) -- join WaitEffect
  GAME:WaitFrames(2) -- join WaitExecuteLives
  SkySceneKit.say({english=" Oh! That's right!", french=" Oh, j'ai failli oublier!", german=" Da fällt mir etwas ein!", italian=" Oh! Aspetta, ora che ci penso...", spanish=" ¡Ah! ¡Es verdad!"}) -- SwitchTalk: branche default (canon générique)
  -- SetAnimation(2) [anim idle native]
  -- SetAnimation(2) [anim idle native]
  -- SetAnimation(2) [anim idle native]
  -- SetAnimation(2) [anim idle native]
