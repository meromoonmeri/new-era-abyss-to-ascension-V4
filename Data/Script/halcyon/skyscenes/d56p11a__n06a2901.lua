...
-- Scène canonique PMD Sky EU : SCRIPT/D56P11A/n06a2901.ssb (ROM sha256 1fa39d35…).
...
return function(hero, partner)
  ...
  GAME:WaitFrames(30)
  pcall(function() UI:SetSpeaker(npc_npc_chaaremu) end)
  SkySceneKit.say({english=" Don't be so slow!", french=" Arrêtez de lambiner!", german=" Hey, nicht ausruhen!", italian=" Datevi una mossa!", spanish=" ¡Deprisa!"})
  pcall(function() UI:SetSpeaker(npc_npc_chaaremu) end)
  SkySceneKit.say({english="We have to break\nthrough somehow!", french=" Il faut trouver un moyen!", german="Wir müssen irgendwie\ndurchkommen!", italian="In qualche modo dobbiamo\narrivare fino in fondo!", spanish="¡Anda![K] Por ahí veo\nuna especie de luz."})
  -- message_Close
