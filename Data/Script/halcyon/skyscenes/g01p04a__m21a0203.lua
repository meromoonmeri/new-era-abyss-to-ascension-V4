...
return function(hero, partner)
  ...
  -- ExecuteCommon(CORO_JUMP_ANGRY_FUNC_SERIES, 0) [gestion de station NDS: le chargement/la coroutine commune est assurée par le harnais journey PMDO]
  GAME:WaitFrames(2) -- join WaitExecuteLives
  SkySceneKit.say({english=" [CS:N]B-Bidoof[CR]!", french=" [CS:N]K-Keunotor[CR]!", german=" [CS:N]B-Bidiza[CR]!", italian=" [CS:N]B-Bidoof[CR]!", spanish=" ¡[CS:N]Bidoof[CR]!"}) -- SwitchTalk: branche default (canon générique)
  -- ExecuteCommon(CORO_JUMP_ANGRY_FUNC_SERIES, 0) [gestion de station NDS: le chargement/la coroutine commune est assurée par le harnais journey PMDO]
  GAME:WaitFrames(2) -- join WaitExecuteLives
  ...
  GAME:WaitFrames(2) -- join WaitExecuteLives
  GROUND:EntTurn(hero, Direction.UpRight)
  SkySceneKit.say({english=" Oh, [CS:N]Corphish[CR]![K] And [CS:N]Sunflora[CR]!", french="Oh, [CS:N]Ecrapince[CR]![K] Et [CS:N]Héliatronc[CR]\naussi!", german=" Oh, [CS:N]Krebscorps[CR]![K] Und [CS:N]Sonnflora[CR]!", italian=" Oh, [CS:N]Corphish[CR]![K] E [CS:N]Sunflora[CR]!", spanish=" ¡[CS:N]Corphish[CR]![K] ¡[CS:N]Sunflora[CR]!"}) -- SwitchTalk: branche default (canon générique)
  GAME:WaitFrames(2) -- join WaitExecuteLives
  pcall(function() GROUND:CharTurnToCharAnimated(hero, npc_npc_kimawari, 4) end)
  -- CallCommon CORO_MESSAGE_CLOSE_WAIT_FUNC (fermeture/attente message: géré par say())
  pcall(function() SOUND:PlayBattleSE("EVT_Emote_Shock") end)
  ...
  GAME:WaitFrames(2) -- join WaitEffect
  GAME:WaitFrames(2) -- join WaitExecuteLives
  SkySceneKit.say({english=" [CS:N]Torkoal[CR], the town elder?", french=" [CS:N]Chartor[CR], l'ancien du bourg?", german=" [CS:N]Qurtel[CR], der Dorfälteste?", italian=" [CS:N]Torkoal[CR], l'anziano della città?", spanish=" ¿[CS:N]Torkoal[CR], el anciano de la aldea?"}) -- SwitchTalk: branche default (canon générique)
  pcall(function() UI:SetSpeaker(npc_npc_perappu) end)
  ...
  GAME:WaitFrames(2) -- join WaitEffect
  GAME:WaitFrames(2) -- join WaitExecuteLives
  SkySceneKit.say({english=" Oh![K] I remember!", french=" Oh![K] Je me souviens!", german=" Oh![K] Ich erinnere mich!", italian=" Ah![K] Mi ricordo!", spanish=" ¡Ah![K] ¡Ya me acuerdo de él!"}) -- SwitchTalk: branche default (canon générique)
