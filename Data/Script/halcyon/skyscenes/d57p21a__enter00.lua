...
-- Scène canonique PMD Sky EU : SCRIPT/D57P21A/enter00.ssb (ROM sha256 1fa39d35…).
...
return function(hero, partner)
  ...
  -- debug_Print('LABEL_KIMAWARI_RESUME') [neutre/état moteur]
  ...
  pcall(function() SOUND:PlayBGM("Lower Spring Cave.ogg", true) end)
  -- debug_Print('LABEL_ENTER_END') [neutre/état moteur]
  -- jump @label_3 [saut final de branche vers l'épilogue commun: flux naturel]
  else
  -- @label_5 [étiquette de flux ExplorerScript]
  -- debug_Print('LABEL_KIMAWARI_SET_NORMAL') [neutre/état moteur]
