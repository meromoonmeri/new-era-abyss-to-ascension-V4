...
return function(hero, partner)
  ...
  SkySceneKit.say({english="(I shielded [CS:N]Grovyle[CR]...?!)", french="(J'ai protégé [CS:N]Massko[CR]...?!)", german="(Ich habe [CS:N]Reptain[CR] geschützt?)", italian="(Ho protetto [CS:N]Grovyle[CR]...?!)", spanish="(¿Protegí a [CS:N]Grovyle[CR]?)"}) -- SwitchMonologue: branche default
  pcall(function() UI:ResetSpeaker() end)
