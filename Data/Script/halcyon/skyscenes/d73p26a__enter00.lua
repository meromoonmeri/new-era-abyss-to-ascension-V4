...
-- Scène canonique PMD Sky EU : SCRIPT/D73P26A/enter00.ssb (ROM sha256 1fa39d35…).
...
return function(hero, partner)
  ...
  SkySceneKit.play_scene("d73p26a__us2300", "d73p26a__us23", hero, partner) -- supervision_ExecuteStationSub(LEVEL_D73P26A, 'US23', 0) [chaînage scène ROM]
  ...
  SkySceneKit.say({english="[CS:P]Sky Peak[CR] 6th Station Clearing.\n6th Station Clearing.", french="[CS:P]Pic Céleste[CR], trouée du 6[F:E] Relais,\ntrouée du 6[F:E] Relais!", german="Nächster Halt [CS:P]Himmelsgipfel[CR]\n6. Zwischenlagerlichtung.\n6. Zwischenlagerlichtung.", italian="Bivacco 6 [CS:P]Picco del Cielo[CR]!\nBivacco 6!", spanish="Base del Sexto Puerto de la\n[CS:P]Cumbre del Cielo[CR].\nHemos llegado a la Base del Sexto Puerto."})
  pcall(function() UI:SetSpeaker(npc_npc_fuwaraido) end)
  ...
  SkySceneKit.play_scene("d73p26a__us2200", "d73p26a__us22", hero, partner) -- supervision_ExecuteStationSub(LEVEL_D73P26A, 'US22', 0) [chaînage scène ROM]
  ...
  SkySceneKit.play_scene("d73p26a__us2100", "d73p26a__us21", hero, partner) -- supervision_ExecuteStationSub(LEVEL_D73P26A, 'US21', 0) [chaînage scène ROM]
  -- jump @label_9 [saut final de branche vers l'épilogue commun: flux naturel]
  elseif (SkyProg.cmp(29, 68) >= 0) then -- elseif ROM: scn($SCENARIO_MAIN) >= [29, 68]
  SkySceneKit.play_scene("d73p26a__us2000", "d73p26a__us20", hero, partner) -- supervision_ExecuteStationSub(LEVEL_D73P26A, 'US20', 0) [chaînage scène ROM]
  -- jump @label_9 [saut final de branche vers l'épilogue commun: flux naturel]
  elseif (SkyProg.cmp(29, 54) >= 0) then -- elseif ROM: scn($SCENARIO_MAIN) >= [29, 54]
  SkySceneKit.play_scene("d73p26a__us0400", "d73p26a__us04", hero, partner) -- supervision_ExecuteStationSub(LEVEL_D73P26A, 'US04', 0) [chaînage scène ROM]
  -- jump @label_9 [saut final de branche vers l'épilogue commun: flux naturel]
  elseif (SkyProg.cmp(29, 40) >= 0) then -- elseif ROM: scn($SCENARIO_MAIN) >= [29, 40]
  SkySceneKit.play_scene("d73p26a__us0300", "d73p26a__us03", hero, partner) -- supervision_ExecuteStationSub(LEVEL_D73P26A, 'US03', 0) [chaînage scène ROM]
  -- jump @label_9 [saut final de branche vers l'épilogue commun: flux naturel]
  elseif (SkyProg.cmp(29, 32) >= 0) then -- elseif ROM: scn($SCENARIO_MAIN) >= [29, 32]
  SkySceneKit.play_scene("d73p26a__us0200", "d73p26a__us02", hero, partner) -- supervision_ExecuteStationSub(LEVEL_D73P26A, 'US02', 0) [chaînage scène ROM]
  -- jump @label_9 [saut final de branche vers l'épilogue commun: flux naturel]
  elseif (SkyProg.cmp(29, 7) >= 0) then -- elseif ROM: scn($SCENARIO_MAIN) >= [29, 7]
  -- @label_8 [étiquette de flux ExplorerScript]
  SkySceneKit.play_scene("d73p26a__us3100", "d73p26a__us31", hero, partner) -- supervision_ExecuteStationSub(LEVEL_D73P26A, 'US31', 0) [chaînage scène ROM]
  -- jump @label_9 [saut final de branche vers l'épilogue commun: flux naturel]
  else
