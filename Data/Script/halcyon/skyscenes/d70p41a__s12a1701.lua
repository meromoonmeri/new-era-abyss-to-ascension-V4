...
-- Scène canonique PMD Sky EU : SCRIPT/D70P41A/s12a1701.ssb (ROM sha256 1fa39d35…).
-- Dialogues 5 langues ROM embarqués ; conventions du pilote m01a0204.
local SkySceneKit = require 'halcyon.skyscenes.kit'
return function(hero, partner)
  pcall(function() SOUND:StopBGM() end)
  -- back_SetGround(LEVEL_D70P41A) [neutre/état moteur]
  ...
  SkySceneKit.say({english="[CN]The treasure box contained...[K]\n[CN]a [CS:I]Grass Cornet[CR]!", french="[CN]Le Coffre au Trésor contient...[K]\n[CN]une [CS:I]Phytocorne[CR]!", german="[CN]Die Schatzbox enthält[K]\n[CN]ein [CS:I]Wiesenhorn[CR]!", italian="[CN]Il forziere contiene...[K]\n[CN]la [CS:I]Cornettaerba[CR]!", spanish="[CN]El cofre del tesoro contenía...[K]\n[CN]¡Una [CS:I]Herbicorneta[CR]!"})
  -- CallCommon CORO_MESSAGE_CLOSE_WAIT_FUNC (fermeture/attente message: géré par say())
  -- item_Set(0, 64, 0) [table d'objets du script NDS: inventaire géré par le moteur PMDO]
  ...
  pcall(function() UI:ResetSpeaker() end)
  SkySceneKit.say({english="[CN]Oh?[K]\n[CN][CS:N]Mew[CR] is saying something.", french="[CN]Oh![K]\n[CN][CS:N]Mew[CR] vous parle.", german="[CN]Oh?[K]\n[CN][CS:N]Mew[CR] will etwas sagen.", italian="[CN]Oh?[K]\n[CN][CS:N]Mew[CR] sta dicendo qualcosa.", spanish="[CN]¿Qué?[K]\n[CN][CS:N]Mew[CR] está diciendo algo."})
  pcall(function() UI:ResetSpeaker() end)
  ...
  -- CallCommon CORO_MESSAGE_CLOSE_WAIT_FUNC (fermeture/attente message: géré par say())
  -- switch(ProcessSpecial(PROCESS_SPECIAL_PREPARE_MENU_ACCEPT_TEAM_MEMBER, 15, 0)) [procédé/menu moteur NDS, corps vide: aucun embranchement canonique — équivalent moteur PMDO]
  ...
  GAME:WaitFrames(10)
  local npc_npc_myuu = SkySceneKit.spawn_npc("mew", 400, 296, Direction.Down, "NPC_MYUU")
  ...
  GAME:WaitFrames(30)
  SV.SkyScenarioBitFlags = SV.SkyScenarioBitFlags or {}; SV.SkyScenarioBitFlags[38] = 0 -- $SCENARIO_MAIN_BIT_FLAG[38] = 0 (ROM)
  ...
  -- CallCommon CORO_MESSAGE_CLOSE_WAIT_FUNC (fermeture/attente message: géré par say())
  pcall(function() UI:ResetSpeaker() end)
  SkySceneKit.say({english="[CN][CS:N]Mew[CR] was turned down\n[CN]as a team member.", french="[CN]Vous avez refusé l'offre\n[CN]de [CS:N]Mew[CR].", german="[CN][CS:N]Mew[CR] wird\n[CN]als Team-Mitglied abgelehnt.", italian="[CN]Non hai accettato [CS:N]Mew[CR] come nuovo membro\n[CN]della squadra.", spanish="[CN]Has rechazado el ofrecimiento de [CS:N]Mew[CR]\n[CN]de formar parte del equipo."})
  -- message_Close
  pcall(function() SOUND:FadeOutBGM(30) end)
  -- GAP: se_Play(7183) — id SE NDS sans portage PMDO identifié
  -- GAP: SetEffect EFFECT_WHITE_LIGHT_ENGULFING — VFX sans émote PMDO équivalente
