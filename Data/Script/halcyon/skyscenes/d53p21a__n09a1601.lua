...
-- Scène canonique PMD Sky EU : SCRIPT/D53P21A/n09a1601.ssb (ROM sha256 1fa39d35…).
...
return function(hero, partner)
  ...
  if (SkyProg.cmp_side(48, 8) >= 0) then -- if ROM: scn($SCENARIO_SIDE) >= [48, 8]
  -- @label_2 [étiquette de flux ExplorerScript]
  -- main_EnterDungeon(147, 30) [transition de zone NDS: assurée par le harnais journey/EnterZone PMDO]
