...
-- Scène canonique PMD Sky EU : SCRIPT/G01P03A/um2503.ssb (ROM sha256 1fa39d35…).
...
return function(hero, partner)
  ...
  local npc_npc_oosubame = SkySceneKit.spawn_npc("swellow", 296, 272, Direction.DownLeft, "NPC_OOSUBAME")
  ...
  -- SetAnimation(2) [anim idle native]
  pcall(function() GROUND:CharTurnToCharAnimated(partner, npc_npc_oosubame, 4) end)
  local npc_npc_kemusso = SkySceneKit.spawn_npc("wurmple", 272, 288, Direction.UpRight, "NPC_KEMUSSO")
  -- SetAnimation(2) [anim idle native]
  -- SetAnimation(2) [anim idle native]
  -- SetAnimation(2) [anim idle native]
