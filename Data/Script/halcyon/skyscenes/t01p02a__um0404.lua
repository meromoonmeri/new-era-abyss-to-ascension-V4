...
-- Scène canonique PMD Sky EU : SCRIPT/T01P02A/um0404.ssb (ROM sha256 1fa39d35…).
...
return function(hero, partner)
  ...
  pcall(function() GROUND:CharTurnToCharAnimated(partner, npc_npc_aabokku, 4) end)
  pcall(function() UI:SetSpeaker(npc_npc_aabokku) end)
  SkySceneKit.say({english="It isssss rare to come by\nnewssssss on [CS:P]Zero Isle[CR]. Right, bossssssss?", french="C'est rare qu'on entende quoi que\nce sssoit sur l'[CS:P]Ile Zéro[CR]. Pas vrai, chef?", german="Esss issst ssschwierig, an\nNeuigkeiten über die [CS:P]Null-Insel[CR] zu kommen.\nNicht wahr, Bossssss?", italian="Sssi hanno raramente notizie\nsssull'[CS:P]Isssola Zero[CR]. Vero, capo?", spanish="No esss nada fácil encontrar\ninformación sssobre la [CS:P]Isla Cero[CR].\n¿Verdad, jefa?"})
  -- message_Close
  -- jump @label_130 [saut final de branche vers l'épilogue commun: flux naturel]
  ...
  pcall(function() GROUND:CharTurnToCharAnimated(partner, npc_npc_aabokku, 4) end)
  pcall(function() UI:SetSpeaker(npc_npc_aabokku) end)
  SkySceneKit.say({english="We traveled all the way out\nhere, but...", french="Nous ssssommes venus de très\nloin...", german="Wir sssind den ganzen Weg\nhierher gereissst...", italian=" Ssssssiamo venuti fin qui, ma...", spanish="Hemosss viajado hasssta aquí,\npero..."})
  pcall(function() UI:SetSpeaker(npc_npc_aabokku) end)
  SkySceneKit.say({english="It turnsssss out that thisssss\nssssspot isssss pretty dingy, issssn't it?", french="Mais finalement, cet endroit,\nil est un peu miteux, non?", german="Diessser Ort ssscheint jedoch\neher ssschäbig zu sssein, oder?", italian="Mi sssembra un posssto un po'\nssssssquallido.", spanish="Essste lugar parece muy lúgubre,\n¿no?"})
  -- message_Close
  -- jump @label_130 [saut final de branche vers l'épilogue commun: flux naturel]
