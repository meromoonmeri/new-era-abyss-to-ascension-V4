...
-- Scène canonique PMD Sky EU : SCRIPT/P01P01A/n04a1501.ssb (ROM sha256 1fa39d35…).
...
return function(hero, partner)
  ...
  pcall(function() UI:SetSpeaker(hero) end)
  SkySceneKit.say({english="I've figured out the trick to his\ninvincibility!", french=" J'ai compris le truc!", german="Ich habe das Geheimnis seiner\nUnbesiegbarkeit durchschaut!", italian="Ho svelato il mistero che si cela\ndietro la sua invincibilità!", spanish="¡Ya he descubierto cuál es su\nsecreto!"})
  -- message_Close
  ...
  -- SetAnimation(2) [anim idle native]
  pcall(function() UI:SetSpeaker(hero) end)
  SkySceneKit.say({english="This time...[K] This time he's not\ngetting away!", french="Cette fois...[K] cette fois,\nil ne m'échappera pas!", german="Dieses Mal...[K] Dieses Mal kommt\ner mir nicht davon!", italian="Questa volta...[K] Questa volta\nnon mi sfuggirà!", spanish="Esta vez...[K] ¡Esta vez\nno se me va a escapar!"})
  pcall(function() UI:SetSpeaker(hero) end)
  SkySceneKit.say({english=" I'm going to do my best!", french=" Je ferai de mon mieux!", german=" Ich werde es ihm schon zeigen!", italian=" Ce la metterò tutta!", spanish=" ¡Voy a darlo todo!"})
