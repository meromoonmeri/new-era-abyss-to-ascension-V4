...
-- Scène canonique PMD Sky EU : SCRIPT/D73P27A/us3104.ssb (ROM sha256 1fa39d35…).
...
return function(hero, partner)
  ...
  -- SetAnimation(2) [anim idle native]
  -- SetAnimation(2) [anim idle native]
  -- Turn2DirectionLives vers ACTOR_NPC_FUWARAIDO [cible sans placement SSA dans la zone (spawn moteur NDS) : orientation non jouée]
