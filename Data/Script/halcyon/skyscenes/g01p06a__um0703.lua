...
return function(hero, partner)
  ...
  SkySceneKit.say({english="Whoa-ho! We're fellow members\nwith you in the expedition, remember?", french="Mouarf! On est vos alliés\npour cette expédition, je vous le rappelle.", german="Whoaho! Wir sind, wie ihr,\nMitglieder der Expedition, schon vergessen?", italian="Uooh-oh! Siamo membri della\nspedizione come voi, ricordate?", spanish="¡Jo, jo! Somos compañeros de\nexpedición, por si no os acordáis."})
  pcall(function() UI:SetSpeaker(npc_npc_dogaasu) end)
  SkySceneKit.say({english="We have to be more open and\ntrusting of one another, whoa-ho-ho!", french="Il faut qu'on soit plus sincères\net qu'on ait confiance les uns envers les\nautres. Mouarf!", german="Wir müssen offener sein und\neinander mehr vertrauen, whoahoho!", italian="Dobbiamo essere più aperti e\nfidarci gli uni degli altri, uooh-oh!", spanish="Hay que ser más abiertos y\nconfiar los unos en los otros... ¡Jo, jo, jo!"})
  -- message_Close
  ...
  pcall(function() GROUND:CharTurnToCharAnimated(partner, npc_npc_dogaasu, 4) end)
  pcall(function() UI:SetSpeaker(npc_npc_dogaasu) end)
  SkySceneKit.say({english=" Whoa-ho! Gonna whine again?", french="Mouarf! Vous allez encore\nvous mettre à pleurnicher?", german="Whoaho! Wollt ihr schon wieder\njammern und heulen?", italian="Uooh-oh! State per mettervi a\npiagnucolare?", spanish=" ¡Vaya! ¿Otra vez a lloriquear?"})
  pcall(function() UI:SetSpeaker(npc_npc_dogaasu) end)
