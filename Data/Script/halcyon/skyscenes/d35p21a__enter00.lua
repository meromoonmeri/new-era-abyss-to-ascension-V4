...
-- Scène canonique PMD Sky EU : SCRIPT/D35P21A/enter00.ssb (ROM sha256 1fa39d35…).
...
return function(hero, partner)
  ...
  -- GAP: BGM BGM_MIRACLE_SEA non mappé au roster (REQUIRES_MOD_ASSET ou canal ambiance)
  ...
  -- back_SetGround(LEVEL_D35P21A) [neutre/état moteur]
