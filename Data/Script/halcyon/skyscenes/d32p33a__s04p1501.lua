...
-- Scène canonique PMD Sky EU : SCRIPT/D32P33A/s04p1501.ssb (ROM sha256 1fa39d35…).
...
return function(hero, partner)
  ...
  SkySceneKit.say({english=" I AM [CS:N]REGISTEEL[CR]...", french=" JE SUIS [CS:N]REGISTEEL[CR]...", german=" ICH BIN [CS:N]REGISTEEL[CR]...", italian=" IO SONO [CS:N]REGISTEEL[CR]...", spanish=" YO SOY [CS:N]REGISTEEL[CR]..."})
  pcall(function() UI:SetSpeaker(npc_npc_rejisuchiru) end)
  ...
  -- CallCommon CORO_MESSAGE_CLOSE_WAIT_FUNC (fermeture/attente message: géré par say())
  -- switch(ProcessSpecial(PROCESS_SPECIAL_PREPARE_MENU_ACCEPT_TEAM_MEMBER, 2, 0)) [procédé/menu moteur NDS, corps vide: aucun embranchement canonique — équivalent moteur PMDO]
  ...
  -- CallCommon CORO_MESSAGE_CLOSE_WAIT_FUNC (fermeture/attente message: géré par say())
  pcall(function() UI:SetSpeaker(npc_npc_rejisuchiru) end)
  SkySceneKit.say({english="[CN][player] turned down\n[CN][CS:N]Registeel[CR]'s offer to join.", french="[CN][player] refuse l'offre\n[CN]de [CS:N]Registeel[CR].", german="[CN][player] lehnt das Beitrittsangebot von\n[CN][CS:N]Registeel[CR] ab.", italian="[CN][player] rifiuta\n[CN]l'offerta di [CS:N]Registeel[CR].", spanish="[CN][player] declinó el ofrecimiento de\n[CN][CS:N]Registeel[CR]."})
  -- message_Close
  pcall(function() SOUND:FadeOutBGM(30) end)
  -- GAP: se_Play(7183) — id SE NDS sans portage PMDO identifié
  -- GAP: SetEffect EFFECT_WHITE_LIGHT_ENGULFING — VFX sans émote PMDO équivalente
