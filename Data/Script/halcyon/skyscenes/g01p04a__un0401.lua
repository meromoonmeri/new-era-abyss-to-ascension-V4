...
-- Scène canonique PMD Sky EU : SCRIPT/G01P04A/un0401.ssb (ROM sha256 1fa39d35…).
...
return function(hero, partner)
  ...
  SkySceneKit.say({english=" ......! ([CS:Y]S-SUNFLORA[CR]!)", french=" ......! ([CS:Y]HE-HELIATRONC[CR]!)", german=" ...([CS:Y]S-SONNFLORA[CR]!)", italian=" ......! ([CS:Y]S-SUNFLORA[CR]!)", spanish=" ¡Ay! (¡Si es [CS:Y]Sunflora[CR]!)"})
  ...
  GAME:WaitFrames(2) -- join WaitExecuteLives
  pcall(function() UI:SetSpeaker(npc_npc_dogoomu) end)
  SkySceneKit.say({english=" Heh-HEH!", french=" Hé... HE!", german=" He-HEEEH!", italian=" Eh EH!", spanish=" Huy, qué planta tan bonita..."})
  -- message_Close
  pcall(function() SOUND:PlayBattleSE("EVT_Emote_Shock") end)
