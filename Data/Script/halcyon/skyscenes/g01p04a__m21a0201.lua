...
return function(hero, partner)
  ...
  SkySceneKit.say({english=" OK...", french=" D'accord...", german=" Okay...", italian=" Ok...", spanish=" Vale..."}) -- SwitchTalk: branche default (canon générique)
  pcall(function() UI:SetSpeaker(npc_npc_perappu) end)
  ...
  -- CallCommon CORO_MESSAGE_CLOSE_WAIT_FUNC (fermeture/attente message: géré par say())
  SkySceneKit.say({english=" Yep!", french=" C'est bien ça.", german=" Jep!", italian=" Già!", spanish=" Eso es."}) -- SwitchTalk: branche default (canon générique)
  pcall(function() UI:SetSpeaker(npc_npc_perappu) end)
  ...
  -- CallCommon CORO_MESSAGE_CLOSE_WAIT_FUNC (fermeture/attente message: géré par say())
  SkySceneKit.say({english=" Yep.", french=" Oui.", german=" Ja.", italian=" Già.", spanish=" Así es."}) -- SwitchTalk: branche default (canon générique)
  pcall(function() UI:SetSpeaker(npc_npc_perappu) end)
  ...
  -- CallCommon CORO_MESSAGE_CLOSE_WAIT_FUNC (fermeture/attente message: géré par say())
  SkySceneKit.say({english=" Yep. And me too.", french=" Oui, et moi aussi.", german=" Jep. Und mich auch.", italian=" Sì. E ha portato anche me.", spanish=" Sí. Y también a mí."}) -- SwitchTalk: branche default (canon générique)
  pcall(function() UI:SetSpeaker(npc_npc_perappu) end)
  ...
  -- CallCommon CORO_MESSAGE_CLOSE_WAIT_FUNC (fermeture/attente message: géré par say())
  SkySceneKit.say({english=" Yep.", french=" Ouaip.", german=" Jep.", italian=" È così.", spanish=" En efecto."}) -- SwitchTalk: branche default (canon générique)
  pcall(function() UI:SetSpeaker(npc_npc_perappu) end)
  ...
  pcall(function() SOUND:PlayBattleSE("EVT_Emote_Sweatdrop") end)
  pcall(function() GROUND:CharSetEmote(partner, "sweating", 1) end)
  SkySceneKit.say({english=" But...!", french=" Pourtant...!", german=" Aber...", italian=" Tuttavia...", spanish=" Pero..."}) -- SwitchTalk: branche default (canon générique)
  -- GAP: se_Play(5122) — id SE NDS sans portage PMDO identifié
  -- SetAnimation(18) [anim idle native]
  GAME:WaitFrames(2) -- join WaitAnimation
  -- SetAnimation(2) [anim idle native]
