...
-- Scène canonique PMD Sky EU : SCRIPT/D73P24A/s31a1801.ssb (ROM sha256 1fa39d35…).
...
return function(hero, partner)
  ...
  -- supervision_Station(40) [gestion de station NDS: le chargement/la coroutine commune est assurée par le harnais journey PMDO]
  -- jump @label_23 [saut final de branche vers l'épilogue commun: flux naturel]
  elseif (SkyProg.cmp(29, 17) >= 0) or (SkyProg.cmp(29, 16) >= 0) or (SkyProg.cmp(29, 15) >= 0) or (SkyProg.cmp(29, 14) >= 0) or (SkyProg.cmp(29, 13) >= 0) or (SkyProg.cmp(29, 12) >= 0) or (SkyProg.cmp(29, 11) >= 0) or (SkyProg.cmp(29, 10) >= 0) or (SkyProg.cmp(29, 8) >= 0) then -- elseif ROM: scn($SCENARIO_MAIN) >= [29, 17] || scn($SCENARIO_MAIN) >= [2
  -- jump @label_23 [saut final de branche vers l'épilogue commun: flux naturel]
  else
  -- jump @label_23 [saut final de branche vers l'épilogue commun: flux naturel]
  end
