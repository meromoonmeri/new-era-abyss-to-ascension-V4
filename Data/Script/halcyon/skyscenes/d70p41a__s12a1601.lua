...
-- Scène canonique PMD Sky EU : SCRIPT/D70P41A/s12a1601.ssb (ROM sha256 1fa39d35…).
-- Dialogues 5 langues ROM embarqués ; conventions du pilote m01a0204.
local SkySceneKit = require 'halcyon.skyscenes.kit'
return function(hero, partner)
  pcall(function() SOUND:StopBGM() end)
  pcall(function() UI:WaitShowTitle(GAME:GetCurrentGround().Name:ToLocal(), 30) end) -- back_SetDungeonBanner(86, 0)
  GAME:FadeIn(16)
  GAME:WaitFrames(60)
  ...
  GROUND:MoveToPosition(hero, 396, 340, false, 2)
  GAME:WaitFrames(10)
  do local __slot = SkySceneKit.team_member(1); if __slot then GROUND:MoveToPosition(__slot, 420, 356, false, 2) end end
  GAME:WaitFrames(10)
  do local __slot = SkySceneKit.team_member(2); if __slot then GROUND:MoveToPosition(__slot, 372, 356, false, 2) end end
  GAME:WaitFrames(10)
  do local __slot = SkySceneKit.team_member(3); if __slot then GROUND:MoveToPosition(__slot, 396, 372, false, 2) end end
  ...
  GAME:WaitFrames(2) -- join WaitExecuteLives
  local npc_npc_myuu = SkySceneKit.spawn_npc("mew", 400, 304, Direction.Down, "NPC_MYUU")
  pcall(function() UI:SetSpeaker(npc_npc_myuu) end)
  ...
  pcall(function() UI:SetSpeaker(npc_npc_myuu) end)
  SkySceneKit.say({english="I am [CS:N]Mew[CR]![K] The guardian of\n[CS:P]Mystery Jungle[CR]!", french="Je suis [CS:N]Mew[CR]![K] Le gardien\nde la [CS:P]Jungle Mystère[CR]!", german="Ich bin [CS:N]Mew[CR],[K] Wächter\ndes [CS:P]Geheimnisdschungels[CR]!", italian="Io sono [CS:N]Mew[CR],[K] il guardiano\ndella [CS:P]Giungla del Mistero[CR]!", spanish="¡Soy [CS:N]Mew[CR]![K]\n¡Y guardo la [CS:P]Selva Misterio[CR]!"})
  pcall(function() UI:SetSpeaker(npc_npc_myuu) end)
  ...
  GAME:WaitFrames(10)
  pcall(function() UI:SetSpeaker(npc_npc_myuu) end)
  SkySceneKit.say({english=" Ascertain the truth...", french=" Faites éclater la vérité...", german=" Erforscht die Wahrheit...", italian=" ... devi cercare la verità.", spanish=" Descubre la verdad..."})
  pcall(function() UI:SetSpeaker(npc_npc_myuu) end)
