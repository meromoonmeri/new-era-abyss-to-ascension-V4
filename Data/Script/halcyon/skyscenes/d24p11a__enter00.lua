...
-- Scène canonique PMD Sky EU : SCRIPT/D24P11A/enter00.ssb (ROM sha256 1fa39d35…).
...
return function(hero, partner)
  ...
  if __sw == 21 then
  SkySceneKit.play_scene("d24p11a__um2000", "d24p11a__um20", hero, partner) -- supervision_ExecuteStationSub(LEVEL_D24P11A, 'UM20', 0) [chaînage scène ROM]
