...
-- Scène canonique PMD Sky EU : SCRIPT/D39P21A/enter00.ssb (ROM sha256 1fa39d35…).
...
return function(hero, partner)
  ...
  if __sw == 29 then
  if (SkyProg.cmp(29, 77) >= 0) then -- if ROM: scn($SCENARIO_MAIN) >= [29, 77]
  SkySceneKit.play_scene("d39p21a__us2100", "d39p21a__us21", hero, partner) -- supervision_ExecuteStationSub(LEVEL_D39P21A, 'US21', 0) [chaînage scène ROM]
