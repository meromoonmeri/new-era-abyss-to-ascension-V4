...
return function(hero, partner)
  ...
  GAME:WaitFrames(30)
  SkySceneKit.say({english=" Take care...[K] [CS:N]Manaphy[CR].", french="Prends bien soin de toi...[K]\n[CS:N]Manaphy[CR].", german=" Lebe wohl...[K] [CS:N]Manaphy[CR].", italian=" Abbi cura di te...[K] [CS:N]Manaphy[CR].", spanish=" Cuídate...[K] [CS:N]Manaphy[CR]."}) -- SwitchTalk: branche default (canon générique)
