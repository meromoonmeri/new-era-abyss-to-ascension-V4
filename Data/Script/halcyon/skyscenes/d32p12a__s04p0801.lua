...
-- Scène canonique PMD Sky EU : SCRIPT/D32P12A/s04p0801.ssb (ROM sha256 1fa39d35…).
...
return function(hero, partner)
  ...
  pcall(function() UI:ResetSpeaker() end)
  SkySceneKit.say({english="[CN]The [CS:I]Unown Stones[CR] in the Treasure Bag:\n[CN][FT:1]R[FT:0], [FT:1]O[FT:0], [FT:1]C[FT:0], and [FT:1]K[FT:0] are responding!", french="[CN]Les [CS:I]Pierres Zarbi[CR] du Sac à Trésor\n[CN][FT:1]R[FT:0], [FT:1]O[FT:0], [FT:1]C[FT:0] et [FT:1]K[FT:0] réagissent!", german="[CN]Die [CS:I]Icognito-Steine[CR] [FT:1]R[FT:0], [FT:1]O[FT:0], [FT:1]C[FT:0] und [FT:1]K[FT:0]\n[CN]aus dem Schatzbeutel reagieren!", italian="[CN]Le [CS:I]Pietre Unown[CR] nella Sacca dei tesori:\n[CN][FT:1]R[FT:0], [FT:1]O[FT:0], [FT:1]C[FT:0] e [FT:1]K[FT:0] stanno reagendo!", spanish="[CN]¡Las [CS:I]Piedras Unown[CR]:\n[CN][FT:1]R[FT:0], [FT:1]O[FT:0], [FT:1]C[FT:0] y [FT:1]K[FT:0]\n[CN]que hay en la Bolsa están reaccionando!"})
  pcall(function() UI:ResetSpeaker() end)
  ...
  -- CallCommon CORO_MESSAGE_CLOSE_WAIT_FUNC (fermeture/attente message: géré par say())
  -- switch(ProcessSpecial(PROCESS_SPECIAL_REMOVE_ITEMS_TYPE_IN_BAG, 417, 0)) [procédé/menu moteur NDS, corps vide: aucun embranchement canonique — équivalent moteur PMDO]
  -- switch(ProcessSpecial(PROCESS_SPECIAL_REMOVE_ITEMS_TYPE_IN_BAG, 414, 0)) [procédé/menu moteur NDS, corps vide: aucun embranchement canonique — équivalent moteur PMDO]
  ...
  -- switch(ProcessSpecial(PROCESS_SPECIAL_REMOVE_ITEMS_TYPE_IN_BAG, 410, 0)) [procédé/menu moteur NDS, corps vide: aucun embranchement canonique — équivalent moteur PMDO]
  ...
  -- message_Close
  SV.SkyScenarioBitFlags = SV.SkyScenarioBitFlags or {}; SV.SkyScenarioBitFlags[44] = 1 -- $SCENARIO_MAIN_BIT_FLAG[44] = 1 (ROM)
  -- GAP: BGM BGM_IN_THE_DEPTHS_OF_THE_PIT non mappé au roster (REQUIRES_MOD_ASSET ou canal ambiance)
