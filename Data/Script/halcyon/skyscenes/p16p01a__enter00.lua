...
-- Scène canonique PMD Sky EU : SCRIPT/P16P01A/enter00.ssb (ROM sha256 1fa39d35…).
...
return function(hero, partner)
  ...
  SkySceneKit.play_scene("p16p01a__un0200", "p16p01a__un02", hero, partner) -- supervision_ExecuteStationSub(LEVEL_P16P01A, 'UN02', 0) [chaînage scène ROM]
