...
-- Scène canonique PMD Sky EU : SCRIPT/H02P99C/s20p0301.ssb (ROM sha256 1fa39d35…).
...
return function(hero, partner)
  ...
  SkyProg.set(29, 71) -- $SCENARIO_MAIN = scn[29,71] (ROM)
  -- back2_SetMode(4) [mode d'affichage sub NDS: géré par SubScreen]
  -- back2_SetGround(V31P01A) [décor sub chargé: Sub_v31p01a]
  ...
  SkySubScreen.Show("v31p01a", 60, false) -- screen2_FadeIn: TOP_FOCUS (timeline ROM)
  GAME:WaitFrames(180)
