...
-- Scène canonique PMD Sky EU : SCRIPT/G01P04A/n01a2601.ssb (ROM sha256 1fa39d35…).
...
return function(hero, partner)
  ...
  SkySceneKit.say({english="Just a little farther to the\nfarthest depths of [CS:P]Star Cave[CR]!", french="Encore un p'tit effort et j'arrive\ndans les entrailles d'la [CS:P]Caverne Etoile[CR]!", german="Nur noch ein bisschen weiter bis\nzu den tiefsten Tiefen der [CS:P]Sternenhöhle[CR]!", italian="Manca poco per raggiungere\nla fine della [CS:P]Caverna Stellata[CR]!", spanish="Ya falta poco para llegar a las\nprofundidades de la [CS:P]Cueva Estrella[CR]."})
  pcall(function() UI:SetSpeaker(hero) end)
  SkySceneKit.say({english="This is my first exploration![K]\nI have to make it a success, yup yup!", french="C'est ma première exploration![K]\nFaut qu'j'la réussisse, pardi!", german="Meine erste Erkundung![K] Sie\nmuss einfach erfolgreich verlaufen, jawollja!", italian="Questa è la mia prima\nesplorazione![K] Voglio che\nsia un successo, già, già!", spanish="¡Esta es mi primera exploración![K]\n¡Tiene que ser todo un éxito, sí, señor!"})
  pcall(function() UI:SetSpeaker(hero) end)
  SkySceneKit.say({english="So... I'm going to do my best\ntoday too, yup yup!", french="Alors... j'vais faire d'mon mieux\naujourd'hui. Ouaip ouaip!", german="Nun denn... Wieder ein Tag, um\nmein Bestes zu geben, jawollja!", italian="Quindi... anche oggi farò\ndel mio meglio, già, già!", spanish="Así que... hoy también voy\na darlo todo. ¡Sí, señor!"})
  -- message_Close
