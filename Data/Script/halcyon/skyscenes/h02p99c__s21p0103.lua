...
return function(hero, partner)
  ...
  do local p=hero.Position; GROUND:MoveToPosition(hero, p.X+(-1), p.Y+(0), false, 2) end -- SlidePositionOffset
  GAME:WaitFrames(2) -- join WaitExecuteLives
  SkySceneKit.say({english="([partner] said to me...)", french="([partner] m'a dit...)", german="([partner] sprach mit mir...)", italian="(... [partner] mi ha detto...)", spanish="([partner] me dijo...)"}) -- SwitchMonologue: branche default
