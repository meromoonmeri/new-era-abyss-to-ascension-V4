...
-- Scène canonique PMD Sky EU : SCRIPT/D01P11A/us0102.ssb (ROM sha256 1fa39d35…).
...
return function(hero, partner)
  ...
  -- CallCommon CORO_MESSAGE_CLOSE_WAIT_FUNC (fermeture/attente message: géré par say())
  -- Turn2DirectionLives ACTOR_NPC_DIGUDA->ACTOR_NPC_DAGUTORIO [sujet sans placement SSA: orientation non jouée]
  GAME:WaitFrames(2) -- join WaitExecuteLives
  pcall(function() UI:SetSpeaker("Diglett", true, "diglett", 0, '', RogueEssence.Data.Gender.Unknown) end) -- locuteur NPC_DIGUDA (espèce ROM, sans placement zone)
  ...
  -- CallCommon CORO_MESSAGE_CLOSE_WAIT_FUNC (fermeture/attente message: géré par say())
  pcall(function() SOUND:PlayBattleSE("EVT_Emote_Confused") end)
  -- SetEffect EFFECT_QUESTION_MARK vers ACTOR_ACTOR_NPC_DIGUDA [acteur sans placement SSA zone (spawn superviseur NDS): émote non jouée]
  GAME:WaitFrames(2) -- join WaitEffect
  GAME:WaitFrames(2) -- join WaitExecuteLives
  pcall(function() UI:SetSpeaker("Diglett", true, "diglett", 0, '', RogueEssence.Data.Gender.Unknown) end) -- locuteur NPC_DIGUDA (espèce ROM, sans placement zone)
  ...
  -- CallCommon CORO_MESSAGE_CLOSE_WAIT_FUNC (fermeture/attente message: géré par say())
  pcall(function() SOUND:PlayBattleSE("EVT_Emote_Sweatdrop") end)
  -- SetEffect EFFECT_SWEAT_DROPS_FROM_BOTH_SIDES_MEDIUM vers ACTOR_ACTOR_NPC_DIGUDA [acteur sans placement SSA zone (spawn superviseur NDS): émote non jouée]
  GAME:WaitFrames(2) -- join WaitEffect
  GAME:WaitFrames(2) -- join WaitExecuteLives
  pcall(function() UI:SetSpeaker("Diglett", true, "diglett", 0, '', RogueEssence.Data.Gender.Unknown) end) -- locuteur NPC_DIGUDA (espèce ROM, sans placement zone)
  ...
  -- message_Close
  -- SetDirection ACTOR_NPC_DIGUDA [acteur sans placement SSA zone: orientation non jouée]
  -- GAP: se_Play(6422) — id SE NDS sans portage PMDO identifié
