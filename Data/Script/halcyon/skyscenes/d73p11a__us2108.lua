...
-- Scène canonique PMD Sky EU : SCRIPT/D73P11A/us2108.ssb (ROM sha256 1fa39d35…).
...
return function(hero, partner)
  ...
  local npc_npc_perippaa1 = SkySceneKit.spawn_npc("pelipper", 200, 328, Direction.DownRight, "NPC_PERIPPAA1")
  ...
  SkySceneKit.say({english="I really dedicate myself\nwholeheartedly to my work!", french="Je me consacre à mon travail\ncorps et âme!", german="Ich widme mich ganzen Herzens\nmeiner Arbeit!", italian="Mi dedico al mio lavoro con\ntutto il cuore!", spanish="Estoy totalmente entregado\na mi trabajo."})
  -- message_Close
  ...
  pcall(function() GROUND:CharTurnToCharAnimated(partner, npc_npc_perippaa1, 4) end)
  pcall(function() UI:SetSpeaker(npc_npc_perippaa1) end)
  SkySceneKit.say({english="Back in business after a\nshort wait!", french="Bientôt de retour aux affaires\naprès une petite pause!", german="Nach kurzen Betriebsferien\nsind wir bald wieder für Sie da!", italian="Eccomi di nuovo in attività dopo\nun breve periodo di pausa!", spanish=" ¡Volveremos a abrir dentro de poco!"})
  pcall(function() UI:SetSpeaker(npc_npc_perippaa1) end)
  SkySceneKit.say({english="I'm hurrying to get prepared.\nPlease be patient with me a little longer!", french="J'essaye de me dépêcher pour\nque tout soit prêt le plus vite possible. Merci\nde votre patience.", german="Bin gerade dabei, alles fertig zu\nbekommen. Habt noch etwas Geduld!", italian="Sto facendo del mio meglio per\nriaprire il prima possibile. Vi prego di avere\nancora un po' di pazienza!", spanish="Me estoy dando prisa para tenerlo\ntodo a punto. ¡Te ruego que tengas solo\nun poquito más de paciencia!"})
  -- message_Close
