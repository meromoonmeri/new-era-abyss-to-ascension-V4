...
-- Scène canonique PMD Sky EU : SCRIPT/D23P11A/enter00.ssb (ROM sha256 1fa39d35…).
...
return function(hero, partner)
  ...
  if __sw == 20 then
  SkySceneKit.play_scene("d23p11a__um1900", "d23p11a__um19", hero, partner) -- supervision_ExecuteStationSub(LEVEL_D23P11A, 'UM19', 0) [chaînage scène ROM]
