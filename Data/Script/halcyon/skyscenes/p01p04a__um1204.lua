...
-- Scène canonique PMD Sky EU : SCRIPT/P01P04A/um1204.ssb (ROM sha256 1fa39d35…).
...
return function(hero, partner)
  ...
  local npc_npc_oosubame = SkySceneKit.spawn_npc("swellow", 448, 232, Direction.Up, "NPC_OOSUBAME")
  ...
  -- SetAnimation(2) [anim idle native]
  pcall(function() GROUND:CharTurnToCharAnimated(partner, npc_npc_oosubame, 4) end)
  local npc_npc_kemusso = SkySceneKit.spawn_npc("wurmple", 424, 232, Direction.Up, "NPC_KEMUSSO")
  -- SetAnimation(2) [anim idle native]
  -- SetAnimation(2) [anim idle native]
  -- SetAnimation(2) [anim idle native]
