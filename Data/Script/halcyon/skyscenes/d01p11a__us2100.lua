...
-- Scène canonique PMD Sky EU : SCRIPT/D01P11A/us2100.ssb (ROM sha256 1fa39d35…).
...
return function(hero, partner)
  ...
  -- debug_Print('LABEL_SET_S21_04') [neutre/état moteur]
  elseif (SkyProg.cmp(29, 81) >= 0) then -- elseif ROM: scn($SCENARIO_MAIN) >= [29, 81]
  -- debug_Print('LABEL_SET_S21_03') [neutre/état moteur]
  elseif (SkyProg.cmp(29, 80) >= 0) then -- elseif ROM: scn($SCENARIO_MAIN) >= [29, 80]
  -- debug_Print('LABEL_SET_S21_02') [neutre/état moteur]
  ...
  -- debug_Print('LABEL_SET_S21_01') [neutre/état moteur]
  -- supervision_Station(10) [gestion de station NDS: le chargement/la coroutine commune est assurée par le harnais journey PMDO]
  else
  end
end
