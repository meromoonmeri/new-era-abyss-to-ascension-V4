...
-- Scène canonique PMD Sky EU : SCRIPT/D73P22A/s31a1101.ssb (ROM sha256 1fa39d35…).
...
return function(hero, partner)
  ...
  -- jump @label_23 [saut final de branche vers l'épilogue commun: flux naturel]
  elseif (SkyProg.cmp(29, 13) >= 0) or (SkyProg.cmp(29, 12) >= 0) or (SkyProg.cmp(29, 11) >= 0) or (SkyProg.cmp(29, 10) >= 0) or (SkyProg.cmp(29, 8) >= 0) then -- elseif ROM: scn($SCENARIO_MAIN) >= [29, 13] || scn($SCENARIO_MAIN) >= [2
  -- jump @label_23 [saut final de branche vers l'épilogue commun: flux naturel]
  else
  -- jump @label_23 [saut final de branche vers l'épilogue commun: flux naturel]
  end
