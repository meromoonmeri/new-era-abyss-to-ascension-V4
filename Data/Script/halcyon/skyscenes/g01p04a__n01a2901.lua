...
-- Scène canonique PMD Sky EU : SCRIPT/G01P04A/n01a2901.ssb (ROM sha256 1fa39d35…).
...
return function(hero, partner)
  ...
  SkySceneKit.say({english=" Just a little farther to [CS:N]Jirachi[CR]!", french="Encore un p'tit effort jusqu'à la\ncachette de [CS:N]Jirachi[CR]!", german="Nur noch ein bisschen\nbis zu [CS:N]Jirachi[CR]!", italian="Ancora poco e raggiungerò\n[CS:N]Jirachi[CR]!", spanish="¡Ya falta poco para llegar a\nla guarida de [CS:N]Jirachi[CR]!"})
  pcall(function() UI:SetSpeaker(hero) end)
  SkySceneKit.say({english="So... I'm going to do my best\ntoday too, yup yup!", french="Alors... j'vais faire d'mon mieux\naujourd'hui. Ouaip ouaip!", german="Okay, ich werde auch heute\nmein Bestes geben, jawollja!", italian="Quindi... anche oggi farò\ndel mio meglio, già, già!", spanish="Así que... hoy también voy\na darlo todo. ¡Sí, señor!"})
  -- message_Close
