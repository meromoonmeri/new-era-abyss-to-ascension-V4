...
-- Scène canonique PMD Sky EU : SCRIPT/D32P32A/s04p1001.ssb (ROM sha256 1fa39d35…).
-- Dialogues 5 langues ROM embarqués ; conventions du pilote m01a0204.
local SkySceneKit = require 'halcyon.skyscenes.kit'
local SkyProg = require 'halcyon.skyscenes.progression'
return function(hero, partner)
  pcall(function() SOUND:StopBGM() end)
  pcall(function() UI:WaitShowTitle(GAME:GetCurrentGround().Name:ToLocal(), 30) end) -- back_SetDungeonBanner(57, 0)
  GAME:FadeIn(16)
  GAME:WaitFrames(60)
  GAME:FadeOut(false, 16)
  GAME:WaitFrames(15)
  if (SkyProg.cmp(29, 62) >= 0) then -- if ROM: scn($SCENARIO_MAIN) >= [29, 62]
  ...
  SkyProg.set(29, 62) -- $SCENARIO_MAIN = scn[29,62] (ROM)
