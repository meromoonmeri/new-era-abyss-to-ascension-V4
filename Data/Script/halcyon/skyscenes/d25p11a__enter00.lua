...
-- Scène canonique PMD Sky EU : SCRIPT/D25P11A/enter00.ssb (ROM sha256 1fa39d35…).
...
return function(hero, partner)
  ...
  if __sw == 24 then
  SkySceneKit.play_scene("d25p11a__um2300", "d25p11a__um23", hero, partner) -- supervision_ExecuteStationSub(LEVEL_D25P11A, 'UM23', 0) [chaînage scène ROM]
