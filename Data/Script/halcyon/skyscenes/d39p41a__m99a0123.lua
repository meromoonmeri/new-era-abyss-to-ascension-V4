...
-- Scène canonique PMD Sky EU : SCRIPT/D39P41A/m99a0123.ssb (ROM sha256 1fa39d35…).
...
return function(hero, partner)
  ...
  GROUND:MoveToPosition(hero, 372, 324, false, 2)
  do local __slot = SkySceneKit.team_member(1); if __slot then GROUND:MoveToPosition(__slot, 396, 340, false, 2) end end
  do local __slot = SkySceneKit.team_member(2); if __slot then GROUND:MoveToPosition(__slot, 348, 340, false, 2) end end
  do local __slot = SkySceneKit.team_member(3); if __slot then GROUND:MoveToPosition(__slot, 372, 356, false, 2) end end
