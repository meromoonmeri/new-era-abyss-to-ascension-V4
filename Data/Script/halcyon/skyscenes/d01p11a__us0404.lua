...
-- Scène canonique PMD Sky EU : SCRIPT/D01P11A/us0404.ssb (ROM sha256 1fa39d35…).
...
return function(hero, partner)
  ...
  local npc_npc_kemusso = SkySceneKit.spawn_npc("wurmple", 544, 208, Direction.Right, "NPC_KEMUSSO")
  ...
  -- SetAnimation(2) [anim idle native]
  local npc_npc_oosubame = SkySceneKit.spawn_npc("swellow", 576, 208, Direction.Left, "NPC_OOSUBAME")
