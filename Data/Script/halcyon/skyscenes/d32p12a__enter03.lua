...
-- Scène canonique PMD Sky EU : SCRIPT/D32P12A/enter03.ssb (ROM sha256 1fa39d35…).
...
return function(hero, partner)
  ...
  -- supervision_ExecuteCommon(CORO_EVENT_S04_23) [gestion de station NDS: le chargement/la coroutine commune est assurée par le harnais journey PMDO]
  elseif true then -- default
  -- supervision_ExecuteCommon(CORO_EVENT_S04_10) [gestion de station NDS: le chargement/la coroutine commune est assurée par le harnais journey PMDO]
