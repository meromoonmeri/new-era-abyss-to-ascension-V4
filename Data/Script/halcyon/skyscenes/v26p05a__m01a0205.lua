...
-- Scène canonique PMD Sky EU : SCRIPT/V26P05A/m01a0205.ssb (ROM sha256 1fa39d35…).
...
return function(hero, partner)
  ...
  -- supervision_SpecialActing(6, 0, 0) [cadrage NDS]
  -- supervision2_SpecialActing(6, 0, 0) [acting sub NDS: décor déjà reproduit par SubScreen, acteurs sub non simulés - trace]
