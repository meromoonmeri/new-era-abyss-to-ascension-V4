...
-- Scène canonique PMD Sky EU : SCRIPT/T01P01A/us2005.ssb (ROM sha256 1fa39d35…).
...
return function(hero, partner)
  ...
  local npc_npc_dorapion = SkySceneKit.spawn_npc("drapion", 376, 176, Direction.UpLeft, "NPC_DORAPION")
  ...
  -- SetAnimation(2) [anim idle native]
  local npc_npc_manyuura = SkySceneKit.spawn_npc("weavile", 352, 152, Direction.Down, "NPC_MANYUURA")
  -- SetAnimation(2) [anim idle native]
  -- SetAnimation(2) [anim idle native]
  pcall(function() GROUND:CharTurnToCharAnimated(partner, npc_npc_dorapion, 4) end)
