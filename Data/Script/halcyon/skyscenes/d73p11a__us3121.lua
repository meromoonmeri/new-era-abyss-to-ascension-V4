...
-- Scène canonique PMD Sky EU : SCRIPT/D73P11A/us3121.ssb (ROM sha256 1fa39d35…).
...
return function(hero, partner)
  ...
  local npc_npc_nyorotono = SkySceneKit.spawn_npc("politoed", 416, 360, Direction.UpLeft, "NPC_NYOROTONO")
  ...
  -- SetAnimation(2) [anim idle native]
  local npc_npc_rediba = SkySceneKit.spawn_npc("ledyba", 376, 360, Direction.UpRight, "NPC_REDIBA")
  -- SetAnimation(2) [anim idle native]
  -- SetAnimation(2) [anim idle native]
  pcall(function() GROUND:CharTurnToCharAnimated(partner, npc_npc_nyorotono, 4) end)
  pcall(function() UI:SetSpeaker(npc_npc_nyorotono) end)
