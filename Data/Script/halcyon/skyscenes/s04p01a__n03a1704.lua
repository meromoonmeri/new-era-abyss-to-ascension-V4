...
-- Scène canonique PMD Sky EU : SCRIPT/S04P01A/n03a1704.ssb (ROM sha256 1fa39d35…).
-- Dialogues 5 langues ROM embarqués ; conventions du pilote m01a0204.
local SkySceneKit = require 'halcyon.skyscenes.kit'
local SkySubScreen = require 'halcyon.skyscenes.subscreen'
return function(hero, partner)
  pcall(function() SOUND:StopBGM() end)
  -- CallCommon CORO_DEBUG_FLAG_SETTING_PUPURIN (fermeture/attente message: géré par say())
  ...
  GAME:FadeIn(5)
  -- GAP: BGM BGM_DEFEND_GLOBE_ENDING non mappé au roster (REQUIRES_MOD_ASSET ou canal ambiance)
  GAME:WaitFrames(200)
  GAME:WaitFrames(70)
