...
-- Scène canonique PMD Sky EU : SCRIPT/D69P41A/s12a1301.ssb (ROM sha256 1fa39d35…).
-- Dialogues 5 langues ROM embarqués ; conventions du pilote m01a0204.
local SkySceneKit = require 'halcyon.skyscenes.kit'
return function(hero, partner)
  pcall(function() SOUND:StopBGM() end)
  pcall(function() UI:WaitShowTitle(GAME:GetCurrentGround().Name:ToLocal(), 30) end) -- back_SetDungeonBanner(82, 0)
  GAME:FadeIn(16)
  GAME:WaitFrames(60)
  ...
  GAME:WaitFrames(2) -- join WaitExecuteLives
  local npc_npc_giratyina = SkySceneKit.spawn_npc("giratina", 304, 208, Direction.Down, "NPC_GIRATYINA")
  pcall(function() UI:SetSpeaker(npc_npc_giratyina) end)
  ...
  pcall(function() UI:SetSpeaker(npc_npc_giratyina) end)
  SkySceneKit.say({english="I am [CS:N]Giratina[CR]![K] The guardian of\n[CS:P]World Abyss[CR]!", french="Je suis [CS:N]Giratina[CR]![K] Le gardien\nde l'[CS:P]Abysse du Monde[CR]!", german="Ich bin [CS:N]Giratina[CR],[K] Wächter\nder [CS:P]Weltenschlucht[CR]!", italian="Io sono [CS:N]Giratina[CR],[K] il guardiano\ndell'[CS:P]Abisso del Mondo[CR]!", spanish="¡Soy [CS:N]Giratina[CR]![K]\n¡Y guardo el [CS:P]Gran Abismo[CR]!"})
  pcall(function() UI:SetSpeaker(npc_npc_giratyina) end)
  ...
  GAME:WaitFrames(10)
  pcall(function() UI:SetSpeaker(npc_npc_giratyina) end)
  SkySceneKit.say({english=" Conquer the silence of darkness...", french="Triomphez du silence\ndes ténèbres...", german=" Besiegt die dunkle Stille...", italian="... devi colmare il silenzio\ndell'oscurità.", spanish=" Conquista el oscuro silencio..."})
  pcall(function() UI:SetSpeaker(npc_npc_giratyina) end)
