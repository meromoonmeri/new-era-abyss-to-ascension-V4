...
-- Scène canonique PMD Sky EU : SCRIPT/D56P11A/enter00.ssb (ROM sha256 1fa39d35…).
...
return function(hero, partner)
  ...
  if (SkyProg.cmp_side(45, 9) < 0) then -- if ROM: scn($SCENARIO_SIDE) < [45, 9]
  ...
  -- debug_Print('LABEL_CHARMS_RESUME') [neutre/état moteur]
  SV.SkyScenarioBitFlags = SV.SkyScenarioBitFlags or {}; SV.SkyScenarioBitFlags[7] = 0 -- $SCENARIO_MAIN_BIT_FLAG[7] = 0 (ROM)
  -- supervision_StationCommon(62) [gestion de station NDS: le chargement/la coroutine commune est assurée par le harnais journey PMDO]
  ...
  -- debug_Print('LABEL_CHARMS_SET_NORMAL') [neutre/état moteur]
  -- supervision_StationCommon(61) [gestion de station NDS: le chargement/la coroutine commune est assurée par le harnais journey PMDO]
