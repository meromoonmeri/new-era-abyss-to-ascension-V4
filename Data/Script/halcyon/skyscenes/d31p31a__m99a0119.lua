...
-- Scène canonique PMD Sky EU : SCRIPT/D31P31A/m99a0119.ssb (ROM sha256 1fa39d35…).
...
return function(hero, partner)
  ...
  pcall(function() UI:ResetSpeaker() end)
  SkySceneKit.say({english="[CN][player] cleared [CS:P]Mystifying Forest[CR]\n[CN]in admirable fashion!", french="[CN][player] a brillamment terminé\n[CN]la [CS:P]Forêt Trompeuse[CR]!", german="[CN][player] meisterte den [CS:P]Verwirrwald[CR]\n[CN]auf beeindruckende Weise!", italian="[CN][player] ha completato la\n[CN][CS:P]Foresta Inganno[CR] in modo eccellente!", spanish="[CN]¡[player] logró atravesar\n[CN]el [CS:P]Bosque Misterio[CR]!"})
  -- message_Close
end
