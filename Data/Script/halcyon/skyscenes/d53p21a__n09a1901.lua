...
-- Scène canonique PMD Sky EU : SCRIPT/D53P21A/n09a1901.ssb (ROM sha256 1fa39d35…).
...
return function(hero, partner)
  ...
  SkySceneKit.say({english=" Ending like this...", french=" Finir comme ça...", german="Auf den letzten Metern eine\nNiederlage zu erleiden...", italian="Non possiamo finire in questo\nmodo...", spanish=" No podemos acabar así..."})
  -- CallCommon CORO_MESSAGE_CLOSE_WAIT_FUNC (fermeture/attente message: géré par say())
