...
function M.Enter(map)
  ...
  pcall(function()
    NNVEcology.Load('nnv_rm82_summer')
    NNVEcology.Setup()
  end)
  LivingWorld.SyncStory()
  M.Context = LivingWorld.Context('no_name_village', 'nnv_rm82_summer')
  ...
  if M.SourceSeason ~= 'ete' then
    error('NNV canonical season mismatch for nnv_rm82_summer: '..tostring(M.SourceSeason))
  end
