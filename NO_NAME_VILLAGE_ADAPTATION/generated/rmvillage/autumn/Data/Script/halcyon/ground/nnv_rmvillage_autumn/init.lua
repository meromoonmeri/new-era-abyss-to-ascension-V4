...
function M.Enter(map)
  ...
  M.Context = LivingWorld.Context('no_name_village', 'nnv_rmvillage_autumn')
  ...
  if M.SourceSeason ~= 'automne' then
    error('NNV canonical season mismatch for nnv_rmvillage_autumn: '..tostring(M.SourceSeason))
  end
