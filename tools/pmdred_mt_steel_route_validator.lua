...
function V:initialize()
 ...
 self.seed=424242;self.started=false;self.groundPending=false;self.task=nil;self.nativeAction=nil;self.attacks=0;self.finishing=false;self.seenEnding=false;self.seenReturn=false
end
