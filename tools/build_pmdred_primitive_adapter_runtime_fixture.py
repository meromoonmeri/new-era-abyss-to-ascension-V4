...
function V:validate_async()
  ...
  assert(not numeric_ok and not unknown_ok and not missing_actor_ok)
  emit('{"event":"fail_closed_pass","numeric_direction":true,"unknown_opcode":true,"missing_actor":true}')
end
function V:begin()
